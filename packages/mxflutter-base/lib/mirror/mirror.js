...
class MXMirror {
    ...
    flutterCallFuncNameMethod(mirrorMethodCall) {
        ...
        log_1.MXJSLog.error(`MXMirror::flutterCallRegisterFuncNameMethod error: func is undefined :${mirrorMethodCall}`);
    }
    // 重置mirror数据
    resetData() {
        this.mirrorIdFeed = 0;
