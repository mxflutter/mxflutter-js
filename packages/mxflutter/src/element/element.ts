...
import { TickerProvider } from '@mxflutter/mxflutter-widgets/material';
...
export class MXJSElement extends MXJSBuildContext {
  ...
  preBuildVsync(value, element) {
    if (value && value instanceof MXJSWidgetState) {
        let vsyncBox = new TickerProvider();
