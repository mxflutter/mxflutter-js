...
import { StatefulWidget, Widget, State, InheritedWidget, GlobalKey } from './framework';
...
class Actions extends StatefulWidget {
  ...
  actions: Map<any, any>;
  child: MXWidget;
  public constructor(namedParameters: {key?: Key, dispatcher?: ActionDispatcher, actions?: Map<any, any>, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
...
class _ActionsMarker extends InheritedWidget {
  ...
  actions: Map<any, any>;
  rebuildKey: any;
  public constructor(namedParameters: {dispatcher?: ActionDispatcher, actions?: Map<any, any>, rebuildKey?: any, key?: Key, child?: MXWidget} = {}) {
    super();
    this.dispatcher = namedParameters.dispatcher;
    this.actions = namedParameters.actions;
...
class FocusableActionDetector extends StatefulWidget {
  ...
  child: MXWidget;
  public constructor(namedParameters: {key?: Key, enabled?: boolean, focusNode?: FocusNode, autofocus?: boolean, shortcuts?: Map<any, any>, actions?: Map<any, any>, onShowFocusHighlight?: any, onShowHoverHighlight?: any, onFocusChange?: any, mouseCursor?: MouseCursor, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
