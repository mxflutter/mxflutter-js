...
class NavigationToolbar extends StatelessWidget {
  ...
  public constructor(namedParameters: {key?: Key, leading?: MXWidget, middle?: MXWidget, trailing?: MXWidget, centerMiddle?: boolean, middleSpacing?: number} = {}) {
    super();
...
class _ToolbarLayout extends MultiChildLayoutDelegate {
  ...
  public constructor(namedParameters: {centerMiddle?: boolean, middleSpacing?: number, textDirection?: TextDirection} = {}) {
    super();
    this.centerMiddle = namedParameters.centerMiddle;
    this.middleSpacing = namedParameters.middleSpacing;
