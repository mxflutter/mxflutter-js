...
import { StatefulWidget, StatelessWidget, State, LeafRenderObjectWidget, Widget } from './framework';
...
class AndroidView extends StatefulWidget {
  ...
  public constructor(namedParameters: {key?: Key, viewType?: string, onPlatformViewCreated?: any, hitTestBehavior?: PlatformViewHitTestBehavior, layoutDirection?: TextDirection, gestureRecognizers?: Set<any>, creationParams?: any, creationParamsCodec?: MessageCodec} = {}) {
    super();
...
class UiKitView extends StatefulWidget {
  ...
  creationParamsCodec: MessageCodec;
  gestureRecognizers: Set<any>;
  public constructor(namedParameters: {key?: Key, viewType?: string, onPlatformViewCreated?: any, hitTestBehavior?: PlatformViewHitTestBehavior, layoutDirection?: TextDirection, creationParams?: any, creationParamsCodec?: MessageCodec, gestureRecognizers?: Set<any>} = {}) {
    super();
    this.key = namedParameters.key;
    this.viewType = namedParameters.viewType;
    this.onPlatformViewCreated = namedParameters.onPlatformViewCreated;
...
class _AndroidPlatformView extends LeafRenderObjectWidget {
  ...
  hitTestBehavior: PlatformViewHitTestBehavior;
  gestureRecognizers: Set<any>;
  public constructor(namedParameters: {key?: Key, controller?: AndroidViewController, hitTestBehavior?: PlatformViewHitTestBehavior, gestureRecognizers?: Set<any>} = {}) {
    super();
    this.key = namedParameters.key;
...
class _UiKitPlatformView extends LeafRenderObjectWidget {
  ...
  hitTestBehavior: PlatformViewHitTestBehavior;
  gestureRecognizers: Set<any>;
  public constructor(namedParameters: {key?: Key, controller?: UiKitViewController, hitTestBehavior?: PlatformViewHitTestBehavior, gestureRecognizers?: Set<any>} = {}) {
    super();
    this.key = namedParameters.key;
    this.controller = namedParameters.controller;
    this.hitTestBehavior = namedParameters.hitTestBehavior;
...
class PlatformViewLink extends StatefulWidget {
  ...
  viewType: string;
  public constructor(namedParameters: {key?: Key, surfaceFactory?: any, onCreatePlatformView?: any, viewType?: string} = {}) {
    super();
    this.key = namedParameters.key;
...
class PlatformViewSurface extends LeafRenderObjectWidget {
  ...
  gestureRecognizers: Set<any>;
  hitTestBehavior: PlatformViewHitTestBehavior;
  public constructor(namedParameters: {key?: Key, controller?: PlatformViewController, hitTestBehavior?: PlatformViewHitTestBehavior, gestureRecognizers?: Set<any>} = {}) {
    super();
    this.key = namedParameters.key;
    this.controller = namedParameters.controller;
    this.hitTestBehavior = namedParameters.hitTestBehavior;
