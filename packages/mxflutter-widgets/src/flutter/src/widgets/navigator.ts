...
class RouteSettings extends MXDartClass {
  name: string;
  mx_arguments: any;
  public constructor(namedParameters: {name?: string, mx_arguments?: any} = {}) {
    super();
...
class Navigator extends StatefulWidget {
  ...
  public constructor(namedParameters: {key?: Key, pages?: Array<any>, onPopPage?: any, initialRoute?: string, onGenerateInitialRoutes?: any, onGenerateRoute?: any, onUnknownRoute?: any, transitionDelegate?: TransitionDelegate, reportsRouteUpdateToEngine?: boolean, observers?: Array<any>} = {}) {
    super();
    this.key = namedParameters.key;
