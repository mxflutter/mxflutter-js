...
class SliverPersistentHeader extends StatelessWidget {
  ...
  pinned: boolean;
  floating: boolean;
  public constructor(namedParameters: {key?: Key, delegate?: SliverPersistentHeaderDelegate, pinned?: boolean, floating?: boolean} = {}) {
    super();
...
class _RenderSliverScrollingPersistentHeaderForWidgets extends RenderSliverScrollingPersistentHeader {
  public constructor(namedParameters: {child?: RenderBox, stretchConfiguration?: OverScrollHeaderStretchConfiguration} = {}) {
    super();
...
class _RenderSliverPinnedPersistentHeaderForWidgets extends RenderSliverPinnedPersistentHeader {
  public constructor(namedParameters: {child?: RenderBox, stretchConfiguration?: OverScrollHeaderStretchConfiguration, showOnScreenConfiguration?: PersistentHeaderShowOnScreenConfiguration} = {}) {
    super();
    this['child'] = namedParameters.child;
    this['stretchConfiguration'] = namedParameters.stretchConfiguration;
...
class _RenderSliverFloatingPinnedPersistentHeaderForWidgets extends RenderSliverFloatingPinnedPersistentHeader {
  public constructor(namedParameters: {child?: RenderBox, vsync?: TickerProvider, snapConfiguration?: FloatingHeaderSnapConfiguration, stretchConfiguration?: OverScrollHeaderStretchConfiguration, showOnScreenConfiguration?: PersistentHeaderShowOnScreenConfiguration} = {}) {
    super();
    this['child'] = namedParameters.child;
