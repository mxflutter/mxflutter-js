...
import { StatelessWidget, SingleChildRenderObjectWidget, Widget } from './framework';
import { MXDartClass, MXMirrorWidget, MXWidget } from '@mxflutter/mxflutter-base';
class SliverFillViewport extends StatelessWidget {
  viewportFraction: number;
  padEnds: boolean;
  delegate: SliverChildDelegate;
  public constructor(namedParameters: {key?: Key, delegate?: SliverChildDelegate, viewportFraction?: number, padEnds?: boolean} = {}) {
    super();
...
class SliverFillRemaining extends StatelessWidget {
  ...
  public constructor(namedParameters: {key?: Key, child?: MXWidget, hasScrollBody?: boolean, fillOverscroll?: boolean} = {}) {
    super();
    this.key = namedParameters.key;
