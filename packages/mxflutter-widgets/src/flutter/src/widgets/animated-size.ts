...
class AnimatedSize extends SingleChildRenderObjectWidget {
  ...
  vsync: any;
  public constructor(namedParameters: {key?: Key, child?: MXWidget, alignment?: AlignmentGeometry, curve?: Curve, duration?: Duration, reverseDuration?: Duration, vsync?: any} = {}) {
    super();
