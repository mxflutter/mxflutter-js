...
import { RenderObjectWidget, RenderObjectElement, SingleChildRenderObjectWidget, Widget, SingleChildRenderObjectElement, ParentDataWidget } from './framework';
...
class SliverChildBuilderDelegate extends SliverChildDelegate {
  ...
  public constructor(builder?: any, namedParameters: {findChildIndexCallback?: any, childCount?: number, addAutomaticKeepAlives?: boolean, addRepaintBoundaries?: boolean, addSemanticIndexes?: boolean, semanticIndexCallback?: any, semanticIndexOffset?: number} = {}) {
    super();
...
class SliverChildListDelegate extends SliverChildDelegate {
  ...
  public constructor(children?: Array<any>, namedParameters: {addAutomaticKeepAlives?: boolean, addRepaintBoundaries?: boolean, addSemanticIndexes?: boolean, semanticIndexCallback?: any, semanticIndexOffset?: number} = {}) {
    super();
  ...
  static fixed(children?: Array<any>, namedParameters: {addAutomaticKeepAlives?: boolean, addRepaintBoundaries?: boolean, addSemanticIndexes?: boolean, semanticIndexCallback?: any, semanticIndexOffset?: number} = {}) {
...
class SliverGrid extends SliverMultiBoxAdaptorWidget {
  ...
  public constructor(namedParameters: {key?: Key, delegate?: SliverChildDelegate, gridDelegate?: SliverGridDelegate} = {}) {
    super();
    this.key = namedParameters.key;
    this.delegate = namedParameters.delegate;
  ...
  static count(namedParameters: {key?: Key, crossAxisCount?: number, mainAxisSpacing?: number, crossAxisSpacing?: number, childAspectRatio?: number, children?: Array<any>} = {}) {
  ...
  static extent(namedParameters: {key?: Key, maxCrossAxisExtent?: number, mainAxisSpacing?: number, crossAxisSpacing?: number, childAspectRatio?: number, children?: Array<any>} = {}) {
    var jsObj = new SliverGrid();
    jsObj.key = namedParameters.key;
...
class SliverOpacity extends SingleChildRenderObjectWidget {
  ...
  public constructor(namedParameters: {key?: Key, opacity?: number, alwaysIncludeSemantics?: boolean, sliver?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
...
class SliverIgnorePointer extends SingleChildRenderObjectWidget {
  ...
  public constructor(namedParameters: {key?: Key, ignoring?: boolean, ignoringSemantics?: boolean, sliver?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
