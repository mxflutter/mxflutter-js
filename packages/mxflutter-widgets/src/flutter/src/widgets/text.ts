...
import { Widget, StatelessWidget } from './framework';
...
class DefaultTextStyle extends InheritedTheme {
  ...
  public constructor(namedParameters: {key?: Key, style?: TextStyle, textAlign?: TextAlign, softWrap?: boolean, overflow?: TextOverflow, maxLines?: number, textWidthBasis?: TextWidthBasis, textHeightBehavior?: TextHeightBehavior, child?: MXWidget} = {}) {
    super();
...
class Text extends StatelessWidget {
  ...
  textWidthBasis: TextWidthBasis;
  textHeightBehavior: TextHeightBehavior;
  public constructor(data?: string, namedParameters: {key?: Key, style?: TextStyle, strutStyle?: StrutStyle, textAlign?: TextAlign, textDirection?: TextDirection, locale?: Locale, softWrap?: boolean, overflow?: TextOverflow, textScaleFactor?: number, maxLines?: number, semanticsLabel?: string, textWidthBasis?: TextWidthBasis, textHeightBehavior?: TextHeightBehavior} = {}) {
    super();
    this.data = data;
    this.key = namedParameters.key;
    this.style = namedParameters.style;
  ...
  static rich(textSpan?: InlineSpan, namedParameters: {key?: Key, style?: TextStyle, strutStyle?: StrutStyle, textAlign?: TextAlign, textDirection?: TextDirection, locale?: Locale, softWrap?: boolean, overflow?: TextOverflow, textScaleFactor?: number, maxLines?: number, semanticsLabel?: string, textWidthBasis?: TextWidthBasis, textHeightBehavior?: TextHeightBehavior} = {}) {
    var jsObj = new Text();
