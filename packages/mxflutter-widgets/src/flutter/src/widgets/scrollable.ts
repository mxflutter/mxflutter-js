...
import { StatefulWidget, InheritedWidget, Widget, State, GlobalKey, SingleChildRenderObjectWidget } from './framework';
...
class Scrollable extends StatefulWidget {
  ...
  public constructor(namedParameters: {key?: Key, axisDirection?: AxisDirection, controller?: ScrollController, physics?: ScrollPhysics, viewportBuilder?: any, incrementCalculator?: any, excludeFromSemantics?: boolean, semanticChildCount?: number, dragStartBehavior?: DragStartBehavior, restorationId?: string} = {}) {
    super();
...
class _ScrollableScope extends InheritedWidget {
  ...
  public constructor(namedParameters: {key?: Key, scrollable?: ScrollableState, position?: ScrollPosition, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
...
class _ScrollSemantics extends SingleChildRenderObjectWidget {
  ...
  semanticChildCount: number;
  public constructor(namedParameters: {key?: Key, position?: ScrollPosition, allowImplicitScrolling?: boolean, semanticChildCount?: number, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
    this.position = namedParameters.position;
...
class _RenderScrollSemantics extends RenderProxyBox {
  ...
  public constructor(namedParameters: {position?: ScrollPosition, allowImplicitScrolling?: boolean, semanticChildCount?: number, child?: RenderBox} = {}) {
    super();
    this.position = namedParameters.position;
    this.allowImplicitScrolling = namedParameters.allowImplicitScrolling;
    this.semanticChildCount = namedParameters.semanticChildCount;
...
export { ScrollAction };
class _RestorableScrollOffset extends RestorableValue {}
