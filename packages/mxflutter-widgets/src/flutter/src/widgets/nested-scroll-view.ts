...
import { ScrollDirection, ViewportOffset } from '../rendering/viewport-offset';
...
import { StatefulWidget, Widget, State, InheritedWidget, SingleChildRenderObjectWidget } from './framework';
...
class NestedScrollView extends StatefulWidget {
  ...
  public constructor(namedParameters: {key?: Key, controller?: ScrollController, scrollDirection?: Axis, reverse?: boolean, physics?: ScrollPhysics, headerSliverBuilder?: any, body?: MXWidget, dragStartBehavior?: DragStartBehavior, floatHeaderSlivers?: boolean, clipBehavior?: Clip, restorationId?: string} = {}) {
    super();
...
class _NestedScrollViewCustomScrollView extends CustomScrollView {
  ...
  public constructor(namedParameters: {scrollDirection?: Axis, reverse?: boolean, physics?: ScrollPhysics, controller?: ScrollController, slivers?: Array<any>, handle?: SliverOverlapAbsorberHandle, clipBehavior?: Clip, dragStartBehavior?: DragStartBehavior, restorationId?: string} = {}) {
    super();
    this.scrollDirection = namedParameters.scrollDirection;
    this.reverse = namedParameters.reverse;
    this.physics = namedParameters.physics;
...
class _NestedScrollMetrics extends FixedScrollMetrics {
  ...
  public constructor(namedParameters: {minScrollExtent?: number, maxScrollExtent?: number, pixels?: number, viewportDimension?: number, axisDirection?: AxisDirection, minRange?: number, maxRange?: number, correctionOffset?: number} = {}) {
    super();
...
class _NestedScrollCoordinator extends MXDartClass {
  ...
  public constructor(_state?: NestedScrollViewState, _parent?: ScrollController, _onHasScrolledBodyChanged?: any, _floatHeaderSlivers?: boolean) {
    super();
    this.state = _state;
    this.parent = _parent;
...
class _NestedScrollController extends ScrollController {
  coordinator: _NestedScrollCoordinator;
  public constructor(coordinator?: _NestedScrollCoordinator, namedParameters: {initialScrollOffset?: number, debugLabel?: string} = {}) {
    super();
...
class _NestedScrollPosition extends ScrollPosition {
  coordinator: _NestedScrollCoordinator;
  parent: ScrollController;
  public constructor(namedParameters: {physics?: ScrollPhysics, context?: ScrollContext, initialPixels?: number, oldPosition?: ScrollPosition, debugLabel?: string, coordinator?: _NestedScrollCoordinator} = {}) {
    super();
    this.physics = namedParameters.physics;
...
class _NestedInnerBallisticScrollActivity extends BallisticScrollActivity {
  coordinator: _NestedScrollCoordinator;
  public constructor(coordinator?: _NestedScrollCoordinator, position?: _NestedScrollPosition, simulation?: Simulation, vsync?: TickerProvider) {
    super();
    this.coordinator = coordinator;
...
class _NestedOuterBallisticScrollActivity extends BallisticScrollActivity {
  ...
  public constructor(coordinator?: _NestedScrollCoordinator, position?: _NestedScrollPosition, metrics?: _NestedScrollMetrics, simulation?: Simulation, vsync?: TickerProvider) {
    super();
    this.coordinator = coordinator;
    this['position'] = position;
...
class NestedScrollViewViewport extends Viewport {
  handle: SliverOverlapAbsorberHandle;
  public constructor(namedParameters: {key?: Key, axisDirection?: AxisDirection, crossAxisDirection?: AxisDirection, anchor?: number, offset?: ViewportOffset, center?: Key, slivers?: Array<any>, handle?: SliverOverlapAbsorberHandle, clipBehavior?: Clip} = {}) {
    super();
    this.key = namedParameters.key;
    this.axisDirection = namedParameters.axisDirection;
...
class RenderNestedScrollViewViewport extends RenderViewport {
  handle: SliverOverlapAbsorberHandle;
  public constructor(namedParameters: {axisDirection?: AxisDirection, crossAxisDirection?: AxisDirection, offset?: ViewportOffset, anchor?: number, children?: Array<any>, center?: RenderSliver, handle?: SliverOverlapAbsorberHandle, clipBehavior?: Clip} = {}) {
    super();
    this.axisDirection = namedParameters.axisDirection;
    this.crossAxisDirection = namedParameters.crossAxisDirection;
    this.offset = namedParameters.offset;
