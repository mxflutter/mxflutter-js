...
class ScrollPositionWithSingleContext extends ScrollPosition {
  ...
  public constructor(namedParameters: {physics?: ScrollPhysics, context?: ScrollContext, initialPixels?: number, keepScrollOffset?: boolean, oldPosition?: ScrollPosition, debugLabel?: string} = {}) {
    super();
