...
import { SingleChildRenderObjectWidget, Widget, StatelessWidget } from './framework';
import { MXDartClass, MXMirrorWidget, MXWidget } from '@mxflutter/mxflutter-base';
class DecoratedBox extends SingleChildRenderObjectWidget {
  decoration: Decoration;
  position: DecorationPosition;
  public constructor(namedParameters: {key?: Key, decoration?: Decoration, position?: DecorationPosition, child?: MXWidget} = {}) {
    super();
...
class Container extends StatelessWidget {
  ...
  transform: Matrix4;
  clipBehavior: Clip;
  public constructor(namedParameters: {key?: Key, alignment?: AlignmentGeometry, padding?: EdgeInsetsGeometry, color?: Color, decoration?: Decoration, foregroundDecoration?: Decoration, width?: number, height?: number, constraints?: BoxConstraints, margin?: EdgeInsetsGeometry, transform?: Matrix4, child?: MXWidget, clipBehavior?: Clip} = {}) {
    super();
    this.key = namedParameters.key;
