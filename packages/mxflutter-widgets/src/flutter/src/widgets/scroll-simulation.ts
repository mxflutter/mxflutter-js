...
class BouncingScrollSimulation extends Simulation {
  ...
  springTime: number;
  timeOffset: number;
  public constructor(namedParameters: {position?: number, velocity?: number, leadingExtent?: number, trailingExtent?: number, spring?: SpringDescription, tolerance?: Tolerance} = {}) {
    super();
...
class ClampingScrollSimulation extends Simulation {
  ...
  duration: number;
  distance: number;
  public constructor(namedParameters: {position?: number, velocity?: number, friction?: number, tolerance?: Tolerance} = {}) {
    super();
    this.position = namedParameters.position;
    this.velocity = namedParameters.velocity;
