...
class DraggableScrollableSheet extends StatefulWidget {
  ...
  expand: boolean;
  builder: any;
  public constructor(namedParameters: {key?: Key, initialChildSize?: number, minChildSize?: number, maxChildSize?: number, expand?: boolean, builder?: any} = {}) {
    super();
...
class DraggableScrollableNotification extends Notification {
  ...
  public constructor(namedParameters: {extent?: number, minExtent?: number, maxExtent?: number, initialExtent?: number, context?: BuildContext} = {}) {
    super();
...
class _DraggableSheetExtent extends MXDartClass {
  ...
  public constructor(namedParameters: {minExtent?: number, maxExtent?: number, initialExtent?: number, listener?: any} = {}) {
    super();
    this.minExtent = namedParameters.minExtent;
    this.maxExtent = namedParameters.maxExtent;
    this.initialExtent = namedParameters.initialExtent;
...
class _DraggableScrollableSheetScrollController extends ScrollController {
  extent: _DraggableSheetExtent;
  public constructor(namedParameters: {initialScrollOffset?: number, debugLabel?: string, extent?: _DraggableSheetExtent} = {}) {
    super();
...
class _DraggableScrollableSheetScrollPosition extends ScrollPositionWithSingleContext {
  ...
  extent: _DraggableSheetExtent;
  public constructor(namedParameters: {physics?: ScrollPhysics, context?: ScrollContext, initialPixels?: number, keepScrollOffset?: boolean, oldPosition?: ScrollPosition, debugLabel?: string, extent?: _DraggableSheetExtent} = {}) {
    super();
