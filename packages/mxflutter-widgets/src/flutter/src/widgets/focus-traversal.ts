...
import { InheritedWidget, Widget, StatefulWidget, State } from './framework';
...
class _FocusTraversalGroupInfo extends MXDartClass {
  ...
  members: Array<any>;
  public constructor(marker?: _FocusTraversalGroupMarker, namedParameters: {defaultPolicy?: FocusTraversalPolicy, members?: Array<any>} = {}) {
    super();
    this['marker'] = marker;
...
class FocusTraversalGroup extends StatefulWidget {
  ...
  child: MXWidget;
  public constructor(namedParameters: {key?: Key, policy?: FocusTraversalPolicy, descendantsAreFocusable?: boolean, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
