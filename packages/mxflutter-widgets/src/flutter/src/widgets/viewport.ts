...
class Viewport extends MultiChildRenderObjectWidget {
  ...
  clipBehavior: Clip;
  public constructor(namedParameters: {key?: Key, axisDirection?: AxisDirection, crossAxisDirection?: AxisDirection, anchor?: number, offset?: ViewportOffset, center?: Key, cacheExtent?: number, cacheExtentStyle?: CacheExtentStyle, clipBehavior?: Clip, slivers?: Array<any>} = {}) {
    super();
...
class ShrinkWrappingViewport extends MultiChildRenderObjectWidget {
  ...
  offset: ViewportOffset;
  clipBehavior: Clip;
  public constructor(namedParameters: {key?: Key, axisDirection?: AxisDirection, crossAxisDirection?: AxisDirection, offset?: ViewportOffset, clipBehavior?: Clip, slivers?: Array<any>} = {}) {
    super();
    this.key = namedParameters.key;
    this.axisDirection = namedParameters.axisDirection;
    this.crossAxisDirection = namedParameters.crossAxisDirection;
