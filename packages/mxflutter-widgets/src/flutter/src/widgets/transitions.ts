...
import { RenderSliverAnimatedOpacity } from '../rendering/proxy-sliver';
import { RenderAnimatedOpacity, DecorationPosition } from '../rendering/proxy-box';
...
import { StatefulWidget$, State$, BuildContext$, Widget, SingleChildRenderObjectWidget } from './framework';
...
class SizeTransition extends AnimatedWidget {
  ...
  child: MXWidget;
  public constructor(
    namedParameters: { key?: Key; axis?: Axis; sizeFactor?: Animation; axisAlignment?: number; child?: MXWidget } = {},
  ) {
    super();
    this.key = namedParameters.key;
...
class FadeTransition extends SingleChildRenderObjectWidget {
  ...
  public constructor(
    namedParameters: { key?: Key; opacity?: Animation; alwaysIncludeSemantics?: boolean; child?: MXWidget } = {},
  ) {
    super();
    this.key = namedParameters.key;
...
class SliverFadeTransition extends SingleChildRenderObjectWidget {
  ...
  alwaysIncludeSemantics: boolean;
  public constructor(
    namedParameters: { key?: Key; opacity?: Animation; alwaysIncludeSemantics?: boolean; sliver?: MXWidget } = {},
  ) {
    super();
    this.key = namedParameters.key;
    this.opacity = namedParameters.opacity;
...
class DecoratedBoxTransition extends AnimatedWidget {
  ...
  child: MXWidget;
  public constructor(
    namedParameters: { key?: Key; decoration?: Animation; position?: DecorationPosition; child?: MXWidget } = {},
  ) {
    super();
    this.key = namedParameters.key;
...
class AnimatedBuilder extends AnimatedWidget {
  ...
  child: MXWidget;
  public constructor(
    namedParameters: { key?: Key; animation?: Listenable; builder?: any; child?: MXWidget; widget?: Widget } = {},
  ) {
    super();
    this.key = namedParameters.key;
