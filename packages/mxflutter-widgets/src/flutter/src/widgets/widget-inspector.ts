...
class _ScreenshotPaintingContext extends PaintingContext {
  ...
  public constructor(namedParameters: {containerLayer?: ContainerLayer, estimatedBounds?: Rect, screenshotData?: _ScreenshotData} = {}) {
    super();
...
class _TransformedRect extends MXDartClass {
  rect: Rect;
  transform: Matrix4;
  public constructor(object?: RenderObject, ancestor?: RenderObject) {
    super();
    this['object'] = object;
...
class _InspectorOverlayRenderState extends MXDartClass {
  ...
  public constructor(namedParameters: {overlayRect?: Rect, selected?: _TransformedRect, candidates?: Array<any>, tooltip?: string, textDirection?: TextDirection} = {}) {
    super();
...
class _InspectorOverlayLayer extends Layer {
  ...
  public constructor(namedParameters: {overlayRect?: Rect, selection?: InspectorSelection, rootRenderObject?: RenderObject} = {}) {
    super();
    this.overlayRect = namedParameters.overlayRect;
    this.selection = namedParameters.selection;
...
class _Location extends MXDartClass {
  ...
  public constructor(namedParameters: {file?: string, line?: number, column?: number, name?: string, parameterLocations?: Array<any>} = {}) {
    super();
...
class InspectorSerializationDelegate extends MXDartClass {
  ...
  public constructor(namedParameters: {groupName?: string, summaryTree?: boolean, maxDescendentsTruncatableNode?: number, expandPropertyValues?: boolean, subtreeDepth?: number, includeProperties?: boolean, service?: WidgetInspectorService, addAdditionalPropertiesCallback?: any} = {}) {
    super();
