...
class PageMetrics extends FixedScrollMetrics {
  viewportFraction: number;
  public constructor(namedParameters: {minScrollExtent?: number, maxScrollExtent?: number, pixels?: number, viewportDimension?: number, axisDirection?: AxisDirection, viewportFraction?: number} = {}) {
    super();
...
class _PagePosition extends ScrollPositionWithSingleContext {
  ...
  viewportFraction: number;
  public constructor(namedParameters: {physics?: ScrollPhysics, context?: ScrollContext, initialPage?: number, keepPage?: boolean, viewportFraction?: number, oldPosition?: ScrollPosition} = {}) {
    super();
...
class PageView extends StatefulWidget {
  ...
  clipBehavior: Clip;
  public constructor(namedParameters: {key?: Key, scrollDirection?: Axis, reverse?: boolean, controller?: PageController, physics?: ScrollPhysics, pageSnapping?: boolean, onPageChanged?: any, children?: Array<any>, dragStartBehavior?: DragStartBehavior, allowImplicitScrolling?: boolean, restorationId?: string, clipBehavior?: Clip} = {}) {
    super();
  ...
  static builder(namedParameters: {key?: Key, scrollDirection?: Axis, reverse?: boolean, controller?: PageController, physics?: ScrollPhysics, pageSnapping?: boolean, onPageChanged?: any, itemBuilder?: any, itemCount?: number, dragStartBehavior?: DragStartBehavior, allowImplicitScrolling?: boolean, restorationId?: string, clipBehavior?: Clip} = {}) {
  ...
  static custom(namedParameters: {key?: Key, scrollDirection?: Axis, reverse?: boolean, controller?: PageController, physics?: ScrollPhysics, pageSnapping?: boolean, onPageChanged?: any, childrenDelegate?: SliverChildDelegate, dragStartBehavior?: DragStartBehavior, allowImplicitScrolling?: boolean, restorationId?: string, clipBehavior?: Clip} = {}) {
    var jsObj = new PageView();
    jsObj.key = namedParameters.key;
    jsObj.scrollDirection = namedParameters.scrollDirection;
    jsObj.reverse = namedParameters.reverse;
