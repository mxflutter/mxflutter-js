...
import { Element$, BuildContext$ } from './framework';
...
class ScrollStartNotification extends ScrollNotification {
  ...
  public constructor(
    namedParameters: { metrics?: ScrollMetrics; context?: BuildContext$; dragDetails?: DragStartDetails } = {},
  ) {
    super();
...
class ScrollEndNotification extends ScrollNotification {
  ...
  public constructor(
    namedParameters: { metrics?: ScrollMetrics; context?: BuildContext$; dragDetails?: DragEndDetails } = {},
  ) {
    super();
    this.metrics = namedParameters.metrics;
    this.context = namedParameters.context;
...
class UserScrollNotification extends ScrollNotification {
  ...
  public constructor(
    namedParameters: { metrics?: ScrollMetrics; context?: BuildContext$; direction?: ScrollDirection } = {},
  ) {
    super();
    this.metrics = namedParameters.metrics;
    this.context = namedParameters.context;
