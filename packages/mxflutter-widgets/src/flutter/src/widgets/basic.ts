...
import { InheritedWidget, Widget, SingleChildRenderObjectWidget, ParentDataWidget, MultiChildRenderObjectWidget, SingleChildRenderObjectElement, StatelessWidget, LeafRenderObjectWidget, StatefulWidget, State } from './framework';
...
class Opacity extends SingleChildRenderObjectWidget {
  ...
  public constructor(namedParameters: {key?: Key, opacity?: number, alwaysIncludeSemantics?: boolean, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
...
class ShaderMask extends SingleChildRenderObjectWidget {
  shaderCallback: any;
  blendMode: BlendMode;
  public constructor(namedParameters: {key?: Key, shaderCallback?: any, blendMode?: BlendMode, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
...
class CustomPaint extends SingleChildRenderObjectWidget {
  ...
  isComplex: boolean;
  willChange: boolean;
  public constructor(namedParameters: {key?: Key, painter?: CustomPainter, foregroundPainter?: CustomPainter, size?: Size, isComplex?: boolean, willChange?: boolean, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
...
class ClipRect extends SingleChildRenderObjectWidget {
  ...
  clipBehavior: Clip;
  public constructor(namedParameters: {key?: Key, clipper?: CustomClipper, clipBehavior?: Clip, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
...
class ClipRRect extends SingleChildRenderObjectWidget {
  ...
  clipper: CustomClipper;
  clipBehavior: Clip;
  public constructor(namedParameters: {key?: Key, borderRadius?: BorderRadius, clipper?: CustomClipper, clipBehavior?: Clip, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
...
class PhysicalModel extends SingleChildRenderObjectWidget {
  ...
  color: Color;
  shadowColor: Color;
  public constructor(namedParameters: {key?: Key, shape?: BoxShape, clipBehavior?: Clip, borderRadius?: BorderRadius, elevation?: number, color?: Color, shadowColor?: Color, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
...
class PhysicalShape extends SingleChildRenderObjectWidget {
  ...
  color: Color;
  shadowColor: Color;
  public constructor(namedParameters: {key?: Key, clipper?: CustomClipper, clipBehavior?: Clip, elevation?: number, color?: Color, shadowColor?: Color, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
    this.clipper = namedParameters.clipper;
    this.clipBehavior = namedParameters.clipBehavior;
...
class Transform extends SingleChildRenderObjectWidget {
  ...
  public constructor(namedParameters: {key?: Key, transform?: Matrix4, origin?: Offset, alignment?: AlignmentGeometry, transformHitTests?: boolean, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
  ...
  static rotate(namedParameters: {key?: Key, angle?: number, origin?: Offset, alignment?: AlignmentGeometry, transformHitTests?: boolean, child?: MXWidget} = {}) {
  ...
  static translate(namedParameters: {key?: Key, offset?: Offset, transformHitTests?: boolean, child?: MXWidget} = {}) {
    var jsObj = new Transform();
    jsObj.key = namedParameters.key;
  ...
  static scale(namedParameters: {key?: Key, scale?: number, origin?: Offset, alignment?: AlignmentGeometry, transformHitTests?: boolean, child?: MXWidget} = {}) {
    var jsObj = new Transform();
    jsObj.key = namedParameters.key;
...
class CompositedTransformFollower extends SingleChildRenderObjectWidget {
  ...
  offset: Offset;
  public constructor(namedParameters: {key?: Key, link?: LayerLink, showWhenUnlinked?: boolean, offset?: Offset, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
    this.link = namedParameters.link;
...
class FittedBox extends SingleChildRenderObjectWidget {
  ...
  alignment: AlignmentGeometry;
  clipBehavior: Clip;
  public constructor(namedParameters: {key?: Key, fit?: BoxFit, alignment?: AlignmentGeometry, clipBehavior?: Clip, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
...
class FractionalTranslation extends SingleChildRenderObjectWidget {
  translation: Offset;
  transformHitTests: boolean;
  public constructor(namedParameters: {key?: Key, translation?: Offset, transformHitTests?: boolean, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
...
class Align extends SingleChildRenderObjectWidget {
  ...
  widthFactor: number;
  heightFactor: number;
  public constructor(namedParameters: {key?: Key, alignment?: AlignmentGeometry, widthFactor?: number, heightFactor?: number, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
    this.alignment = namedParameters.alignment;
...
class Center extends Align {
  public constructor(namedParameters: {key?: Key, widthFactor?: number, heightFactor?: number, child?: MXWidget} = {}) {
    super();
    this['key'] = namedParameters.key;
    this['widthFactor'] = namedParameters.widthFactor;
    this['heightFactor'] = namedParameters.heightFactor;
...
class UnconstrainedBox extends SingleChildRenderObjectWidget {
  ...
  clipBehavior: Clip;
  public constructor(namedParameters: {key?: Key, child?: MXWidget, textDirection?: TextDirection, alignment?: AlignmentGeometry, constrainedAxis?: Axis, clipBehavior?: Clip} = {}) {
    super();
    this.key = namedParameters.key;
    this.child = namedParameters.child;
    this.textDirection = namedParameters.textDirection;
...
class OverflowBox extends SingleChildRenderObjectWidget {
  ...
  minHeight: number;
  maxHeight: number;
  public constructor(namedParameters: {key?: Key, alignment?: AlignmentGeometry, minWidth?: number, maxWidth?: number, minHeight?: number, maxHeight?: number, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
    this.alignment = namedParameters.alignment;
...
class SizedOverflowBox extends SingleChildRenderObjectWidget {
  alignment: AlignmentGeometry;
  size: Size;
  public constructor(namedParameters: {key?: Key, size?: Size, alignment?: AlignmentGeometry, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
    this.size = namedParameters.size;
    this.alignment = namedParameters.alignment;
...
class Baseline extends SingleChildRenderObjectWidget {
  ...
  public constructor(namedParameters: {key?: Key, baseline?: number, baselineType?: TextBaseline, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
...
class Stack extends MultiChildRenderObjectWidget {
  ...
  overflow: Overflow;
  clipBehavior: Clip;
  public constructor(namedParameters: {key?: Key, alignment?: AlignmentGeometry, textDirection?: TextDirection, fit?: StackFit, overflow?: Overflow, clipBehavior?: Clip, children?: Array<any>} = {}) {
    super();
    this.key = namedParameters.key;
    this.alignment = namedParameters.alignment;
    this.textDirection = namedParameters.textDirection;
...
class IndexedStack extends Stack {
  index: number;
  public constructor(namedParameters: {key?: Key, alignment?: AlignmentGeometry, textDirection?: TextDirection, sizing?: StackFit, index?: number, children?: Array<any>} = {}) {
    super();
    this.key = namedParameters.key;
    this.alignment = namedParameters.alignment;
    this.textDirection = namedParameters.textDirection;
...
class Positioned extends ParentDataWidget {
  ...
  width: number;
  height: number;
  public constructor(namedParameters: {key?: Key, left?: number, top?: number, right?: number, bottom?: number, width?: number, height?: number, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
  ...
  static directional(namedParameters: {key?: Key, textDirection?: TextDirection, start?: number, top?: number, end?: number, bottom?: number, width?: number, height?: number, child?: MXWidget} = {}) {
  ...
  static fill(namedParameters: {key?: Key, left?: number, top?: number, right?: number, bottom?: number, child?: MXWidget} = {}) {
    var jsObj = new Positioned();
    jsObj.key = namedParameters.key;
...
class PositionedDirectional extends StatelessWidget {
  ...
  height: number;
  child: MXWidget;
  public constructor(namedParameters: {key?: Key, start?: number, top?: number, end?: number, bottom?: number, width?: number, height?: number, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
...
class Flex extends MultiChildRenderObjectWidget {
  ...
  clipBehavior: Clip;
  public constructor(namedParameters: {key?: Key, direction?: Axis, mainAxisAlignment?: MainAxisAlignment, mainAxisSize?: MainAxisSize, crossAxisAlignment?: CrossAxisAlignment, textDirection?: TextDirection, verticalDirection?: VerticalDirection, textBaseline?: TextBaseline, clipBehavior?: Clip, children?: Array<any>} = {}) {
    super();
    this.key = namedParameters.key;
...
class Row extends Flex {
  public constructor(namedParameters: {key?: Key, mainAxisAlignment?: MainAxisAlignment, mainAxisSize?: MainAxisSize, crossAxisAlignment?: CrossAxisAlignment, textDirection?: TextDirection, verticalDirection?: VerticalDirection, textBaseline?: TextBaseline, children?: Array<any>} = {}) {
    super();
    this['key'] = namedParameters.key;
    this['mainAxisAlignment'] = namedParameters.mainAxisAlignment;
    this['mainAxisSize'] = namedParameters.mainAxisSize;
...
class Wrap extends MultiChildRenderObjectWidget {
  ...
  verticalDirection: VerticalDirection;
  clipBehavior: Clip;
  public constructor(namedParameters: {key?: Key, direction?: Axis, alignment?: WrapAlignment, spacing?: number, runAlignment?: WrapAlignment, runSpacing?: number, crossAxisAlignment?: WrapCrossAlignment, textDirection?: TextDirection, verticalDirection?: VerticalDirection, clipBehavior?: Clip, children?: Array<any>} = {}) {
    super();
    this.key = namedParameters.key;
    this.direction = namedParameters.direction;
    this.alignment = namedParameters.alignment;
...
class RichText extends MultiChildRenderObjectWidget {
  ...
  public constructor(namedParameters: {key?: Key, text?: InlineSpan, textAlign?: TextAlign, textDirection?: TextDirection, softWrap?: boolean, overflow?: TextOverflow, textScaleFactor?: number, maxLines?: number, locale?: Locale, strutStyle?: StrutStyle, textWidthBasis?: TextWidthBasis, textHeightBehavior?: TextHeightBehavior} = {}) {
    super();
    this.key = namedParameters.key;
...
class RawImage extends LeafRenderObjectWidget {
  ...
  isAntiAlias: boolean;
  public constructor(namedParameters: {key?: Key, image?: Image, debugImageLabel?: string, width?: number, height?: number, scale?: number, color?: Color, colorBlendMode?: BlendMode, fit?: BoxFit, alignment?: AlignmentGeometry, repeat?: ImageRepeat, centerSlice?: Rect, matchTextDirection?: boolean, invertColors?: boolean, filterQuality?: FilterQuality, isAntiAlias?: boolean} = {}) {
    super();
    this.key = namedParameters.key;
...
class Listener extends StatelessWidget {
  ...
  child: MXWidget;
  public constructor(namedParameters: {key?: Key, onPointerDown?: any, onPointerMove?: any, onPointerEnter?: any, onPointerExit?: any, onPointerHover?: any, onPointerUp?: any, onPointerCancel?: any, onPointerSignal?: any, behavior?: HitTestBehavior, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
...
class _PointerListener extends SingleChildRenderObjectWidget {
  ...
  onPointerSignal: any;
  behavior: HitTestBehavior;
  public constructor(namedParameters: {key?: Key, onPointerDown?: any, onPointerMove?: any, onPointerUp?: any, onPointerCancel?: any, onPointerSignal?: any, behavior?: HitTestBehavior, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
    this.onPointerDown = namedParameters.onPointerDown;
    this.onPointerMove = namedParameters.onPointerMove;
...
class MouseRegion extends StatefulWidget {
  ...
  opaque: boolean;
  child: MXWidget;
  public constructor(namedParameters: {key?: Key, onEnter?: any, onExit?: any, onHover?: any, cursor?: MouseCursor, opaque?: boolean, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
...
class IgnorePointer extends SingleChildRenderObjectWidget {
  ...
  public constructor(namedParameters: {key?: Key, ignoring?: boolean, ignoringSemantics?: boolean, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
...
class AbsorbPointer extends SingleChildRenderObjectWidget {
  absorbing: boolean;
  ignoringSemantics: boolean;
  public constructor(namedParameters: {key?: Key, absorbing?: boolean, child?: MXWidget, ignoringSemantics?: boolean} = {}) {
    super();
    this.key = namedParameters.key;
...
class MetaData extends SingleChildRenderObjectWidget {
  metaData: any;
  behavior: HitTestBehavior;
  public constructor(namedParameters: {key?: Key, metaData?: any, behavior?: HitTestBehavior, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
...
class Semantics extends SingleChildRenderObjectWidget {
  ...
  public constructor(namedParameters: {key?: Key, child?: MXWidget, container?: boolean, explicitChildNodes?: boolean, excludeSemantics?: boolean, enabled?: boolean, checked?: boolean, selected?: boolean, toggled?: boolean, button?: boolean, link?: boolean, header?: boolean, textField?: boolean, readOnly?: boolean, focusable?: boolean, focused?: boolean, inMutuallyExclusiveGroup?: boolean, obscured?: boolean, multiline?: boolean, scopesRoute?: boolean, namesRoute?: boolean, hidden?: boolean, image?: boolean, liveRegion?: boolean, maxValueLength?: number, currentValueLength?: number, label?: string, value?: string, increasedValue?: string, decreasedValue?: string, hint?: string, onTapHint?: string, onLongPressHint?: string, textDirection?: TextDirection, sortKey?: SemanticsSortKey, onTap?: any, onLongPress?: any, onScrollLeft?: any, onScrollRight?: any, onScrollUp?: any, onScrollDown?: any, onIncrease?: any, onDecrease?: any, onCopy?: any, onCut?: any, onPaste?: any, onDismiss?: any, onMoveCursorForwardByCharacter?: any, onMoveCursorBackwardByCharacter?: any, onSetSelection?: any, onDidGainAccessibilityFocus?: any, onDidLoseAccessibilityFocus?: any, customSemanticsActions?: Map<any, any>} = {}) {
    super();
    this.key = namedParameters.key;
    this.child = namedParameters.child;
  ...
  static fromProperties(namedParameters: {key?: Key, child?: MXWidget, container?: boolean, explicitChildNodes?: boolean, excludeSemantics?: boolean, properties?: SemanticsProperties} = {}) {
