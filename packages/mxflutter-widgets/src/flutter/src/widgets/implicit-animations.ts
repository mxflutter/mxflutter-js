...
import { StatefulWidget$, State$, Widget, BuildContext$ } from './framework';
...
class AnimatedPositioned extends ImplicitlyAnimatedWidget {
  ...
  static fromRect(
    namedParameters: { key?: Key; child?: MXWidget; rect?: Rect; curve?: Curve; duration?: Duration; onEnd?: any } = {},
  ) {
