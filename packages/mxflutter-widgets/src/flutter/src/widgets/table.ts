...
import { RenderObjectWidget, RenderObjectElement, ParentDataWidget, Widget } from './framework';
...
class Table extends RenderObjectWidget {
  ...
  public constructor(namedParameters: {key?: Key, children?: Array<any>, columnWidths?: Map<any, any>, defaultColumnWidth?: TableColumnWidth, textDirection?: TextDirection, border?: TableBorder, defaultVerticalAlignment?: TableCellVerticalAlignment, textBaseline?: TextBaseline} = {}) {
    super();
    this.key = namedParameters.key;
    this.children = namedParameters.children;
...
class TableCell extends ParentDataWidget {
  ...
  public constructor(namedParameters: {key?: Key, verticalAlignment?: TableCellVerticalAlignment, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
