...
class SafeArea extends StatelessWidget {
  ...
  child: MXWidget;
  public constructor(namedParameters: {key?: Key, left?: boolean, top?: boolean, right?: boolean, bottom?: boolean, minimum?: EdgeInsets, maintainBottomViewPadding?: boolean, child?: MXWidget} = {}) {
    super();
...
class SliverSafeArea extends StatelessWidget {
  ...
  minimum: EdgeInsets;
  sliver: MXWidget;
  public constructor(namedParameters: {key?: Key, left?: boolean, top?: boolean, right?: boolean, bottom?: boolean, minimum?: EdgeInsets, sliver?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
    this.left = namedParameters.left;
    this.top = namedParameters.top;
