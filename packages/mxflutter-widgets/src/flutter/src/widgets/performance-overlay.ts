...
class PerformanceOverlay extends LeafRenderObjectWidget {
  ...
  public constructor(namedParameters: {key?: Key, optionsMask?: number, rasterizerThreshold?: number, checkerboardRasterCacheImages?: boolean, checkerboardOffscreenLayers?: boolean} = {}) {
    super();
  ...
  static allEnabled(namedParameters: {key?: Key, rasterizerThreshold?: number, checkerboardRasterCacheImages?: boolean, checkerboardOffscreenLayers?: boolean} = {}) {
