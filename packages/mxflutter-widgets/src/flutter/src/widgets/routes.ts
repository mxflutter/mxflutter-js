...
import { InheritedWidget, Widget, StatefulWidget$, State$, BuildContext$, GlobalKey } from './framework';
import { DismissAction, DismissIntent } from './actions';
...
class _ModalScopeStatus extends InheritedWidget {
  ...
  route: Route;
  public constructor(
    namedParameters: { key?: Key; isCurrent?: boolean; canPop?: boolean; route?: Route; child?: MXWidget } = {},
  ) {
    super();
