...
class FadeInImage extends StatelessWidget {
  ...
  public constructor(namedParameters: {key?: Key, placeholder?: ImageProvider, placeholderErrorBuilder?: any, image?: ImageProvider, imageErrorBuilder?: any, excludeFromSemantics?: boolean, imageSemanticLabel?: string, fadeOutDuration?: Duration, fadeOutCurve?: Curve, fadeInDuration?: Duration, fadeInCurve?: Curve, width?: number, height?: number, fit?: BoxFit, alignment?: AlignmentGeometry, repeat?: ImageRepeat, matchTextDirection?: boolean} = {}) {
    super();
  ...
  static memoryNetwork(namedParameters: {key?: Key, placeholder?: any, placeholderErrorBuilder?: any, image?: string, imageErrorBuilder?: any, placeholderScale?: number, imageScale?: number, excludeFromSemantics?: boolean, imageSemanticLabel?: string, fadeOutDuration?: Duration, fadeOutCurve?: Curve, fadeInDuration?: Duration, fadeInCurve?: Curve, width?: number, height?: number, fit?: BoxFit, alignment?: AlignmentGeometry, repeat?: ImageRepeat, matchTextDirection?: boolean, placeholderCacheWidth?: number, placeholderCacheHeight?: number, imageCacheWidth?: number, imageCacheHeight?: number} = {}) {
  ...
  static assetNetwork(namedParameters: {key?: Key, placeholder?: string, placeholderErrorBuilder?: any, image?: string, imageErrorBuilder?: any, bundle?: AssetBundle, placeholderScale?: number, imageScale?: number, excludeFromSemantics?: boolean, imageSemanticLabel?: string, fadeOutDuration?: Duration, fadeOutCurve?: Curve, fadeInDuration?: Duration, fadeInCurve?: Curve, width?: number, height?: number, fit?: BoxFit, alignment?: AlignmentGeometry, repeat?: ImageRepeat, matchTextDirection?: boolean, placeholderCacheWidth?: number, placeholderCacheHeight?: number, imageCacheWidth?: number, imageCacheHeight?: number} = {}) {
    var jsObj = new FadeInImage();
    jsObj.key = namedParameters.key;
    jsObj['mx_placeholder'] = namedParameters.placeholder;
    jsObj.placeholderErrorBuilder = namedParameters.placeholderErrorBuilder;
...
class _AnimatedFadeOutFadeIn extends ImplicitlyAnimatedWidget {
  ...
  fadeInCurve: Curve;
  fadeOutCurve: Curve;
  public constructor(namedParameters: {key?: Key, target?: MXWidget, placeholder?: MXWidget, isTargetLoaded?: boolean, fadeOutDuration?: Duration, fadeOutCurve?: Curve, fadeInDuration?: Duration, fadeInCurve?: Curve} = {}) {
    super();
    this.key = namedParameters.key;
