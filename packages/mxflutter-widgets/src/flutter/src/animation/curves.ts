...
abstract class ParametricCurve extends MXDartClass {}
export { ParametricCurve };
abstract class Curve extends ParametricCurve {}
export { Curve };
...
class Interval extends Curve {
  ...
  curve: Curve;
  public constructor(begin?: number, end?: number, namedParameters: {curve?: Curve} = {}) {
    super();
    this.begin = begin;
    this.end = end;
...
class Cubic extends Curve {
  ...
  public transformInternal(t: number) {
    ...
    while (true) {
      ...
      if (Math.abs(t - estimate) < 0.001) return this.evaluateCubic(this.b, this.d, midpoint);
      if (estimate < t) start = midpoint;
      else end = midpoint;
    }
  }

  protected evaluateCubic(a: number, b: number, m: number) {
    return 3 * a * (1 - m) * (1 - m) * m + 3 * b * (1 - m) * m * m + m * m * m;
  }
  // MX modified end
}
export { Cubic };
abstract class Curve2D extends ParametricCurve {}
export { Curve2D };
class Curve2DSample extends MXDartClass {
  t: number;
  value: Offset;
  public constructor(t?: number, value?: Offset) {
    super();
    this.t = t;
    this.value = value;
...
class CatmullRomSpline extends Curve2D {
  ...
  endHandle: Offset;
  tension: number;
  public constructor(controlPoints?: Array<any>, namedParameters: {tension?: number, startHandle?: Offset, endHandle?: Offset} = {}) {
    super();
  ...
  static precompute(controlPoints?: Array<any>, namedParameters: {tension?: number, startHandle?: Offset, endHandle?: Offset} = {}) {
...
class CatmullRomCurve extends Curve {
  ...
  controlPoints: Array<any>;
  tension: number;
  public constructor(controlPoints?: Array<any>, namedParameters: {tension?: number} = {}) {
    super();
    this.controlPoints = controlPoints;
    this.tension = namedParameters.tension;
    this.className = 'CatmullRomCurve';
  }
  static precompute(controlPoints?: Array<any>, namedParameters: {tension?: number} = {}) {
