...
class AnimationController extends Animation {
  ...
  lastReportedStatus: AnimationStatus;
   // MX Modified begin
  vsync: any;
  public constructor(namedParameters: {value?: number, duration?: Duration, reverseDuration?: Duration, debugLabel?: string, lowerBound?: number, upperBound?: number, animationBehavior?: AnimationBehavior, vsync?: any} = {}) {
    super();
  ...
  static unbounded(namedParameters: {value?: number, duration?: Duration, reverseDuration?: Duration, debugLabel?: string, vsync?: any, animationBehavior?: AnimationBehavior} = {}) {
...
class _RepeatingSimulation extends Simulation {
  ...
  initialT: number;
  public constructor(initialValue?: number, min?: number, max?: number, reverse?: boolean, period?: Duration, directionSetter?: any) {
    super();
