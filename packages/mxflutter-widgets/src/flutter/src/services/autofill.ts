...
import { TextEditingValue, TextInputConfiguration, TextInputClient } from './text-input';
...
class _AutofillScopeTextInputConfiguration extends TextInputConfiguration {
  ...
  public constructor(
    namedParameters: { allConfigurations?: any; currentClientConfiguration?: TextInputConfiguration } = {},
  ) {
    super();
