...
class DragStartDetails extends MXDartClass {
  ...
  globalPosition: Offset;
  localPosition: Offset;
  public constructor(namedParameters: {sourceTimeStamp?: Duration, globalPosition?: Offset, localPosition?: Offset} = {}) {
    super();
...
class DragUpdateDetails extends MXDartClass {
  ...
  globalPosition: Offset;
  localPosition: Offset;
  public constructor(namedParameters: {sourceTimeStamp?: Duration, delta?: Offset, primaryDelta?: number, globalPosition?: Offset, localPosition?: Offset} = {}) {
    super();
    this.sourceTimeStamp = namedParameters.sourceTimeStamp;
