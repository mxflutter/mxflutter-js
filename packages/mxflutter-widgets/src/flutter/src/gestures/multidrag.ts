...
import { PointerMoveEvent, PointerDownEvent, PointerEvent } from './events';
import { GestureArenaEntry, GestureDisposition } from './arena';
...
class _ImmediatePointerState extends MultiDragPointerState {
  public constructor(initialPosition?: Offset) {
    super();
...
class _DelayedPointerState extends MultiDragPointerState {
  timer: any;
  starter: any;
  public constructor(initialPosition?: Offset, delay?: Duration) {
    super();
    this.initialPosition = initialPosition;
    this['delay'] = delay;
