...
class _TapTracker extends MXDartClass {
  ...
  public constructor(namedParameters: {event?: PointerDownEvent, entry?: GestureArenaEntry, doubleTapMinTime?: Duration} = {}) {
    super();
...
class _TapGesture extends _TapTracker {
  ...
  public constructor(namedParameters: {gestureRecognizer?: MultiTapGestureRecognizer, event?: PointerEvent, longTapDelay?: Duration} = {}) {
    super();
