...
import { Rect, TextDirection, Color, Canvas } from '../../../mx-dart-sdk';
...
class Border extends BoxBorder {
  ...
  left: BorderSide;
  public constructor(
    namedParameters: { top?: BorderSide; right?: BorderSide; bottom?: BorderSide; left?: BorderSide } = {},
  ) {
    super();
...
class BorderDirectional extends BoxBorder {
  ...
  bottom: BorderSide;
  public constructor(
    namedParameters: { top?: BorderSide; start?: BorderSide; end?: BorderSide; bottom?: BorderSide } = {},
  ) {
    super();
    this.top = namedParameters.top;
