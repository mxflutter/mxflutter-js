...
class ImageConfiguration extends MXDartClass {
  ...
  public constructor(namedParameters: {bundle?: AssetBundle, devicePixelRatio?: number, locale?: Locale, textDirection?: TextDirection, size?: Size, platform?: TargetPlatform} = {}) {
    super();
...
class ResizeImage extends ImageProvider {
  ...
  public constructor(imageProvider?: ImageProvider, namedParameters: {width?: number, height?: number, allowUpscaling?: boolean} = {}) {
    super();
...
class ExactAssetImage extends AssetBundleImageProvider {
  ...
  bundle: AssetBundle;
  __mx_package: string;
  public constructor(assetName?: string, namedParameters: {scale?: number, bundle?: AssetBundle, __mx_package?: string} = {}) {
    super();
