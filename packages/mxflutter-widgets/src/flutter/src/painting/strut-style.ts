...
class StrutStyle extends MXDartClass {
  ...
  debugLabel: string;
  public constructor(namedParameters: {fontFamily?: string, fontFamilyFallback?: Array<any>, fontSize?: number, height?: number, leading?: number, fontWeight?: FontWeight, fontStyle?: FontStyle, forceStrutHeight?: boolean, debugLabel?: string, __mx_package?: string} = {}) {
    super();
  ...
  static fromTextStyle(textStyle?: TextStyle, namedParameters: {fontFamily?: string, fontFamilyFallback?: Array<any>, fontSize?: number, height?: number, leading?: number, fontWeight?: FontWeight, fontStyle?: FontStyle, forceStrutHeight?: boolean, debugLabel?: string, __mx_package?: string} = {}) {
    var jsObj = new StrutStyle();
