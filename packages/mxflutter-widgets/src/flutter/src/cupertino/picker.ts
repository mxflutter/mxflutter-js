...
import { StatefulWidget, State, SingleChildRenderObjectWidget, Widget } from '../widgets/framework';
...
class CupertinoPicker extends StatefulWidget {
  ...
  public constructor(namedParameters: {key?: Key, diameterRatio?: number, backgroundColor?: Color, offAxisFraction?: number, useMagnifier?: boolean, magnification?: number, scrollController?: FixedExtentScrollController, squeeze?: number, itemExtent?: number, onSelectedItemChanged?: any, children?: Array<any>, looping?: boolean} = {}) {
    super();
  ...
  static builder(namedParameters: {key?: Key, diameterRatio?: number, backgroundColor?: Color, offAxisFraction?: number, useMagnifier?: boolean, magnification?: number, scrollController?: FixedExtentScrollController, squeeze?: number, itemExtent?: number, onSelectedItemChanged?: any, itemBuilder?: any, childCount?: number} = {}) {
...
class _CupertinoPickerSemantics extends SingleChildRenderObjectWidget {
  scrollController: FixedExtentScrollController;
  public constructor(namedParameters: {key?: Key, child?: MXWidget, scrollController?: FixedExtentScrollController} = {}) {
    super();
    this.key = namedParameters.key;
