...
class CupertinoSlidingSegmentedControl extends StatefulWidget {
  ...
  public constructor(namedParameters: {key?: Key, children?: Map<any, any>, onValueChanged?: any, groupValue?: any, thumbColor?: Color, padding?: EdgeInsetsGeometry, backgroundColor?: Color} = {}) {
    super();
...
class _SegmentedControlRenderWidget extends MultiChildRenderObjectWidget {
  ...
  public constructor(namedParameters: {key?: Key, children?: Array<any>, selectedIndex?: number, thumbColor?: Color, state?: _SegmentedControlState} = {}) {
    super();
    this.key = namedParameters.key;
    this.children = namedParameters.children;
...
class _RenderSegmentedControl extends RenderBox {
  ...
  pressedIndex: number;
  thumbColor: Color;
  public constructor(namedParameters: {selectedIndex?: number, thumbColor?: Color, state?: _SegmentedControlState} = {}) {
    super();
    this['selectedIndex'] = namedParameters.selectedIndex;
    this.thumbColor = namedParameters.thumbColor;
    this.state = namedParameters.state;
