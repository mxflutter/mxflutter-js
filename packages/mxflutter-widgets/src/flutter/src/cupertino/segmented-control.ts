...
class CupertinoSegmentedControl extends StatefulWidget {
  ...
  public constructor(namedParameters: {key?: Key, children?: Map<any, any>, onValueChanged?: any, groupValue?: any, unselectedColor?: Color, selectedColor?: Color, borderColor?: Color, pressedColor?: Color, padding?: EdgeInsetsGeometry} = {}) {
    super();
...
class _SegmentedControlRenderWidget extends MultiChildRenderObjectWidget {
  ...
  borderColor: Color;
  public constructor(namedParameters: {key?: Key, children?: Array<any>, selectedIndex?: number, pressedIndex?: number, backgroundColors?: Array<any>, borderColor?: Color} = {}) {
    super();
    this.key = namedParameters.key;
    this.children = namedParameters.children;
...
class _RenderSegmentedControl extends RenderBox {
  ...
  backgroundColors: Array<any>;
  borderColor: Color;
  public constructor(namedParameters: {selectedIndex?: number, pressedIndex?: number, textDirection?: TextDirection, backgroundColors?: Array<any>, borderColor?: Color} = {}) {
    super();
    this.selectedIndex = namedParameters.selectedIndex;
    this.pressedIndex = namedParameters.pressedIndex;
