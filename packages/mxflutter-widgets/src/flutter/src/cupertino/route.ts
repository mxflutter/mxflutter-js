...
import { Canvas, Offset, Color, ImageFilter } from '../../../mx-dart-sdk';
...
import { BuildContext$, Widget, StatelessWidget$, StatefulWidget$, State$ } from '../widgets/framework';
import { TransitionRoute, PopupRoute } from '../widgets/routes';
import { Route, RouteSettings, Page, NavigatorState } from '../widgets/navigator';
...
class _CupertinoBackGestureDetector extends StatefulWidget$ {
  ...
  public constructor(
    namedParameters: { key?: Key; enabledCallback?: any; onStartPopGesture?: any; child?: MXWidget } = {},
  ) {
    super();
    this.key = namedParameters.key;
