...
class CupertinoTextField extends StatefulWidget {
  ...
  public constructor(namedParameters: {key?: Key, controller?: TextEditingController, focusNode?: FocusNode, decoration?: BoxDecoration, padding?: EdgeInsetsGeometry, placeholder?: string, placeholderStyle?: TextStyle, prefix?: MXWidget, prefixMode?: OverlayVisibilityMode, suffix?: MXWidget, suffixMode?: OverlayVisibilityMode, clearButtonMode?: OverlayVisibilityMode, keyboardType?: TextInputType, textInputAction?: TextInputAction, textCapitalization?: TextCapitalization, style?: TextStyle, strutStyle?: StrutStyle, textAlign?: TextAlign, textAlignVertical?: TextAlignVertical, readOnly?: boolean, toolbarOptions?: ToolbarOptions, showCursor?: boolean, autofocus?: boolean, obscuringCharacter?: string, obscureText?: boolean, autocorrect?: boolean, smartDashesType?: SmartDashesType, smartQuotesType?: SmartQuotesType, enableSuggestions?: boolean, maxLines?: number, minLines?: number, expands?: boolean, maxLength?: number, maxLengthEnforced?: boolean, onChanged?: any, onEditingComplete?: any, onSubmitted?: any, inputFormatters?: Array<any>, enabled?: boolean, cursorWidth?: number, cursorHeight?: number, cursorRadius?: Radius, cursorColor?: Color, selectionHeightStyle?: BoxHeightStyle, selectionWidthStyle?: BoxWidthStyle, keyboardAppearance?: Brightness, scrollPadding?: EdgeInsets, dragStartBehavior?: DragStartBehavior, enableInteractiveSelection?: boolean, onTap?: any, scrollController?: ScrollController, scrollPhysics?: ScrollPhysics, autofillHints?: any, restorationId?: string} = {}) {
    super();
