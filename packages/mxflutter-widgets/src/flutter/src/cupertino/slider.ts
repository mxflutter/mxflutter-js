...
class CupertinoSlider extends StatefulWidget {
  ...
  activeColor: Color;
  thumbColor: Color;
  public constructor(namedParameters: {key?: Key, value?: number, onChanged?: any, onChangeStart?: any, onChangeEnd?: any, min?: number, max?: number, divisions?: number, activeColor?: Color, thumbColor?: Color} = {}) {
    super();
...
class _CupertinoSliderRenderObjectWidget extends LeafRenderObjectWidget {
  ...
  public constructor(namedParameters: {key?: Key, value?: number, divisions?: number, activeColor?: Color, thumbColor?: Color, onChanged?: any, onChangeStart?: any, onChangeEnd?: any, vsync?: TickerProvider} = {}) {
    super();
    this.key = namedParameters.key;
    this.value = namedParameters.value;
    this.divisions = namedParameters.divisions;
...
class _RenderCupertinoSlider extends RenderConstrainedBox {
  ...
  public constructor(namedParameters: {value?: number, divisions?: number, activeColor?: Color, thumbColor?: Color, trackColor?: Color, onChanged?: any, onChangeStart?: any, onChangeEnd?: any, vsync?: TickerProvider, textDirection?: TextDirection} = {}) {
    super();
    this.value = namedParameters.value;
    this.divisions = namedParameters.divisions;
    this.activeColor = namedParameters.activeColor;
