...
import { StatelessWidget, Widget, RenderObjectWidget, RenderObjectElement, Element, StatefulWidget, State, ParentDataWidget, MultiChildRenderObjectWidget } from '../widgets/framework';
...
class CupertinoAlertDialog extends StatelessWidget {
  ...
  public constructor(namedParameters: {key?: Key, title?: MXWidget, content?: MXWidget, actions?: Array<any>, scrollController?: ScrollController, actionScrollController?: ScrollController, insetAnimationDuration?: Duration, insetAnimationCurve?: Curve} = {}) {
    super();
...
class _RenderCupertinoDialog extends RenderBox {
  ...
  dividerPaint: Paint;
  public constructor(namedParameters: {contentSection?: RenderBox, actionsSection?: RenderBox, dividerThickness?: number, isInAccessibilityMode?: boolean, dividerColor?: Color} = {}) {
    super();
    this.contentSection = namedParameters.contentSection;
    this.actionsSection = namedParameters.actionsSection;
...
class _CupertinoAlertContentSection extends StatelessWidget {
  ...
  content: MXWidget;
  scrollController: ScrollController;
  public constructor(namedParameters: {key?: Key, title?: MXWidget, content?: MXWidget, scrollController?: ScrollController} = {}) {
    super();
    this.key = namedParameters.key;
    this.title = namedParameters.title;
    this.content = namedParameters.content;
...
class CupertinoDialogAction extends StatelessWidget {
  ...
  textStyle: TextStyle;
  child: MXWidget;
  public constructor(namedParameters: {key?: Key, onPressed?: any, isDefaultAction?: boolean, isDestructiveAction?: boolean, textStyle?: TextStyle, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
...
class _RenderCupertinoDialogActions extends RenderBox {
  ...
  dividerPaint: Paint;
  public constructor(namedParameters: {children?: Array<any>, dialogWidth?: number, dividerThickness?: number, dialogColor?: Color, dialogPressedColor?: Color, dividerColor?: Color} = {}) {
    super();
    this['children'] = namedParameters.children;
