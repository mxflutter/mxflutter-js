...
import { SingleChildRenderObjectWidget, Widget, StatefulWidget, State } from '../widgets/framework';
...
class _CupertinoSliverRefresh extends SingleChildRenderObjectWidget {
  ...
  public constructor(namedParameters: {key?: Key, refreshIndicatorLayoutExtent?: number, hasLayoutExtent?: boolean, child?: MXWidget} = {}) {
    super();
...
class _RenderCupertinoSliverRefresh extends RenderSliver {
  ...
  public constructor(namedParameters: {refreshIndicatorExtent?: number, hasLayoutExtent?: boolean, child?: RenderBox} = {}) {
    super();
...
class CupertinoSliverRefreshControl extends StatefulWidget {
  ...
  builder: any;
  onRefresh: any;
  public constructor(namedParameters: {key?: Key, refreshTriggerPullDistance?: number, refreshIndicatorExtent?: number, builder?: any, onRefresh?: any} = {}) {
    super();
    this.key = namedParameters.key;
