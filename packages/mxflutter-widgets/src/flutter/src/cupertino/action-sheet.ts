...
import { StatelessWidget, Widget, StatefulWidget, State, RenderObjectWidget, RenderObjectElement, Element, ParentDataWidget, MultiChildRenderObjectWidget } from '../widgets/framework';
...
class CupertinoActionSheet extends StatelessWidget {
  ...
  public constructor(namedParameters: {key?: Key, title?: MXWidget, message?: MXWidget, actions?: Array<any>, messageScrollController?: ScrollController, actionScrollController?: ScrollController, cancelButton?: MXWidget} = {}) {
    super();
...
class CupertinoActionSheetAction extends StatelessWidget {
  ...
  child: MXWidget;
  public constructor(namedParameters: {key?: Key, onPressed?: any, isDefaultAction?: boolean, isDestructiveAction?: boolean, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
...
class _RenderCupertinoAlert extends RenderBox {
  ...
  dividerPaint: Paint;
  public constructor(namedParameters: {contentSection?: RenderBox, actionsSection?: RenderBox, dividerThickness?: number, dividerColor?: Color} = {}) {
    super();
    this.contentSection = namedParameters.contentSection;
    this.actionsSection = namedParameters.actionsSection;
...
class _CupertinoAlertContentSection extends StatelessWidget {
  ...
  public constructor(namedParameters: {key?: Key, title?: MXWidget, message?: MXWidget, scrollController?: ScrollController} = {}) {
    super();
    this.key = namedParameters.key;
    this.title = namedParameters.title;
    this.message = namedParameters.message;
...
class _CupertinoAlertActionSection extends StatefulWidget {
  ...
  public constructor(namedParameters: {key?: Key, children?: Array<any>, scrollController?: ScrollController, hasCancelButton?: boolean} = {}) {
    super();
    this.key = namedParameters.key;
...
class _CupertinoAlertActionsRenderWidget extends MultiChildRenderObjectWidget {
  dividerThickness: number;
  hasCancelButton: boolean;
  public constructor(namedParameters: {key?: Key, actionButtons?: Array<any>, dividerThickness?: number, hasCancelButton?: boolean} = {}) {
    super();
    this.key = namedParameters.key;
...
class _RenderCupertinoAlertActions extends RenderBox {
  ...
  dividerPaint: Paint;
  public constructor(namedParameters: {children?: Array<any>, dividerThickness?: number, dividerColor?: Color, hasCancelButton?: boolean, backgroundColor?: Color, pressedColor?: Color} = {}) {
    super();
    this['children'] = namedParameters.children;
    this.dividerThickness = namedParameters.dividerThickness;
    this['dividerColor'] = namedParameters.dividerColor;
