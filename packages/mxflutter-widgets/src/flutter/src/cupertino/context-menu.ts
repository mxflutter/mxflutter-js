...
import { TapUpDetails, TapDownDetails } from '../gestures/tap';
...
import { StatefulWidget$, Widget, State$, GlobalKey, BuildContext$, StatelessWidget$ } from '../widgets/framework';
...
class CupertinoContextMenu extends StatefulWidget$ {
  ...
  previewBuilder: any;
  public constructor(
    namedParameters: { key?: Key; actions?: Array<any>; child?: MXWidget; previewBuilder?: any } = {},
  ) {
    super();
