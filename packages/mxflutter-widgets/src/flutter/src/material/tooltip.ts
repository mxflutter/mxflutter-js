...
import { StatefulWidget, Widget, State, StatelessWidget } from '../widgets/framework';
...
class Tooltip extends StatefulWidget {
  ...
  public constructor(namedParameters: {key?: Key, message?: string, height?: number, padding?: EdgeInsetsGeometry, margin?: EdgeInsetsGeometry, verticalOffset?: number, preferBelow?: boolean, excludeFromSemantics?: boolean, decoration?: Decoration, textStyle?: TextStyle, waitDuration?: Duration, showDuration?: Duration, child?: MXWidget} = {}) {
    super();
...
class _TooltipOverlay extends StatelessWidget {
  ...
  verticalOffset: number;
  preferBelow: boolean;
  public constructor(namedParameters: {key?: Key, message?: string, height?: number, padding?: EdgeInsetsGeometry, margin?: EdgeInsetsGeometry, decoration?: Decoration, textStyle?: TextStyle, animation?: Animation, target?: Offset, verticalOffset?: number, preferBelow?: boolean} = {}) {
    super();
    this.key = namedParameters.key;
    this.message = namedParameters.message;
    this.height = namedParameters.height;
