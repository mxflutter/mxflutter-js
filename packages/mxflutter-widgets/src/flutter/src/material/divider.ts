...
class Divider extends StatelessWidget {
  ...
  endIndent: number;
  color: Color;
  public constructor(namedParameters: {key?: Key, height?: number, thickness?: number, indent?: number, endIndent?: number, color?: Color} = {}) {
    super();
...
class VerticalDivider extends StatelessWidget {
  ...
  endIndent: number;
  color: Color;
  public constructor(namedParameters: {key?: Key, width?: number, thickness?: number, indent?: number, endIndent?: number, color?: Color} = {}) {
    super();
    this.key = namedParameters.key;
