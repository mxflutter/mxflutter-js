...
class TooltipThemeData extends MXDartClass {
  ...
  public constructor(namedParameters: {height?: number, padding?: EdgeInsetsGeometry, margin?: EdgeInsetsGeometry, verticalOffset?: number, preferBelow?: boolean, excludeFromSemantics?: boolean, decoration?: Decoration, textStyle?: TextStyle, waitDuration?: Duration, showDuration?: Duration} = {}) {
    super();
