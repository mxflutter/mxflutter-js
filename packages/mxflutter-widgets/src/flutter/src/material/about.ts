...
class _AboutProgram extends StatelessWidget$ {
  ...
  legalese: string;
  public constructor(
    namedParameters: { key?: Key; name?: string; version?: string; icon?: MXWidget; legalese?: string } = {},
  ) {
    super();
    this.key = namedParameters.key;
...
class _PackagesView extends StatefulWidget$ {
  ...
  selectedId: ValueNotifier;
  public constructor(
    namedParameters: { key?: Key; about?: MXWidget; isLateral?: boolean; selectedId?: ValueNotifier } = {},
  ) {
    super();
    this.key = namedParameters.key;
...
class _DetailView extends StatelessWidget$ {
  builder: any;
  __mx_arguments: any;
  public constructor(namedParameters: { key?: Key; builder?: any; __mx_arguments?: any } = {}) {
    super();
    this.key = namedParameters.key;
