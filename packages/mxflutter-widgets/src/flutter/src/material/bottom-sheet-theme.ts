...
class BottomSheetThemeData extends MXDartClass {
  ...
  shape: ShapeBorder;
  clipBehavior: Clip;
  public constructor(namedParameters: {backgroundColor?: Color, elevation?: number, modalBackgroundColor?: Color, modalElevation?: number, shape?: ShapeBorder, clipBehavior?: Clip} = {}) {
    super();
