...
class AnimatedIcon extends StatelessWidget {
  ...
  public constructor(namedParameters: {key?: Key, icon?: AnimatedIconData, progress?: Animation, color?: Color, size?: number, semanticLabel?: string, textDirection?: TextDirection} = {}) {
    super();
...
class _AnimatedIconPainter extends CustomPainter {
  ...
  uiPathFactory: any;
  public constructor(namedParameters: {paths?: Array<any>, progress?: Animation, color?: Color, scale?: number, shouldMirror?: boolean, uiPathFactory?: any} = {}) {
    super();
