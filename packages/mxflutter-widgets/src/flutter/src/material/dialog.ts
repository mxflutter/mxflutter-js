...
class Dialog extends StatelessWidget {
  ...
  shape: ShapeBorder;
  child: MXWidget;
  public constructor(namedParameters: {key?: Key, backgroundColor?: Color, elevation?: number, insetAnimationDuration?: Duration, insetAnimationCurve?: Curve, insetPadding?: EdgeInsets, clipBehavior?: Clip, shape?: ShapeBorder, child?: MXWidget} = {}) {
    super();
...
class AlertDialog extends StatelessWidget {
  ...
  shape: ShapeBorder;
  scrollable: boolean;
  public constructor(namedParameters: {key?: Key, title?: MXWidget, titlePadding?: EdgeInsetsGeometry, titleTextStyle?: TextStyle, content?: MXWidget, contentPadding?: EdgeInsetsGeometry, contentTextStyle?: TextStyle, actions?: Array<any>, actionsPadding?: EdgeInsetsGeometry, actionsOverflowDirection?: VerticalDirection, actionsOverflowButtonSpacing?: number, buttonPadding?: EdgeInsetsGeometry, backgroundColor?: Color, elevation?: number, semanticLabel?: string, insetPadding?: EdgeInsets, clipBehavior?: Clip, shape?: ShapeBorder, scrollable?: boolean} = {}) {
    super();
    this.key = namedParameters.key;
...
class SimpleDialog extends StatelessWidget {
  ...
  semanticLabel: string;
  shape: ShapeBorder;
  public constructor(namedParameters: {key?: Key, title?: MXWidget, titlePadding?: EdgeInsetsGeometry, titleTextStyle?: TextStyle, children?: Array<any>, contentPadding?: EdgeInsetsGeometry, backgroundColor?: Color, elevation?: number, semanticLabel?: string, shape?: ShapeBorder} = {}) {
    super();
    this.key = namedParameters.key;
    this.title = namedParameters.title;
    this.titlePadding = namedParameters.titlePadding;
