...
class InkHighlight extends InteractiveInkFeature {
  ...
  active: boolean;
  public constructor(namedParameters: {controller?: MaterialInkController, referenceBox?: RenderBox, color?: Color, textDirection?: TextDirection, shape?: BoxShape, radius?: number, borderRadius?: BorderRadius, customBorder?: ShapeBorder, rectCallback?: any, onRemoved?: any, fadeDuration?: Duration} = {}) {
    super();
