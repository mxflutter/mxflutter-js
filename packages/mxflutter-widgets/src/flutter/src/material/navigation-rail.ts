...
import { StatefulWidget, Widget, State, StatelessWidget, InheritedWidget } from '../widgets/framework';
...
class NavigationRail extends StatefulWidget {
  ...
  public constructor(namedParameters: {backgroundColor?: Color, extended?: boolean, leading?: MXWidget, trailing?: MXWidget, destinations?: Array<any>, selectedIndex?: number, onDestinationSelected?: any, elevation?: number, groupAlignment?: number, labelType?: NavigationRailLabelType, unselectedLabelTextStyle?: TextStyle, selectedLabelTextStyle?: TextStyle, unselectedIconTheme?: IconThemeData, selectedIconTheme?: IconThemeData, minWidth?: number, minExtendedWidth?: number} = {}) {
    super();
...
class _RailDestination extends StatelessWidget {
  ...
  public constructor(namedParameters: {minWidth?: number, minExtendedWidth?: number, icon?: MXWidget, label?: MXWidget, destinationAnimation?: Animation, extendedTransitionAnimation?: Animation, labelType?: NavigationRailLabelType, selected?: boolean, iconTheme?: IconThemeData, labelTextStyle?: TextStyle, onTap?: any, indexLabel?: string} = {}) {
    super();
    this.minWidth = namedParameters.minWidth;
    this.minExtendedWidth = namedParameters.minExtendedWidth;
