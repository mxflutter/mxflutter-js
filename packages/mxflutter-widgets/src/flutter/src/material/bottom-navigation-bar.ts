...
class BottomNavigationBar extends StatefulWidget {
  ...
  public constructor(namedParameters: {key?: Key, items?: Array<any>, onTap?: any, currentIndex?: number, elevation?: number, type?: BottomNavigationBarType, fixedColor?: Color, backgroundColor?: Color, iconSize?: number, selectedItemColor?: Color, unselectedItemColor?: Color, selectedIconTheme?: IconThemeData, unselectedIconTheme?: IconThemeData, selectedFontSize?: number, unselectedFontSize?: number, selectedLabelStyle?: TextStyle, unselectedLabelStyle?: TextStyle, showSelectedLabels?: boolean, showUnselectedLabels?: boolean, mouseCursor?: MouseCursor} = {}) {
    super();
...
class _BottomNavigationTile extends StatelessWidget {
  ...
  showUnselectedLabels: boolean;
  mouseCursor: MouseCursor;
  public constructor(type?: BottomNavigationBarType, item?: BottomNavigationBarItem, animation?: Animation, iconSize?: number, namedParameters: {onTap?: any, colorTween?: ColorTween, flex?: number, selected?: boolean, selectedLabelStyle?: TextStyle, unselectedLabelStyle?: TextStyle, selectedIconTheme?: IconThemeData, unselectedIconTheme?: IconThemeData, showSelectedLabels?: boolean, showUnselectedLabels?: boolean, indexLabel?: string, mouseCursor?: MouseCursor} = {}) {
    super();
    this.type = type;
    this.item = item;
...
class _TileIcon extends StatelessWidget {
  ...
  selectedIconTheme: IconThemeData;
  unselectedIconTheme: IconThemeData;
  public constructor(namedParameters: {key?: Key, colorTween?: ColorTween, animation?: Animation, iconSize?: number, selected?: boolean, item?: BottomNavigationBarItem, selectedIconTheme?: IconThemeData, unselectedIconTheme?: IconThemeData} = {}) {
    super();
    this.key = namedParameters.key;
    this.colorTween = namedParameters.colorTween;
...
class _Label extends StatelessWidget {
  ...
  showSelectedLabels: boolean;
  showUnselectedLabels: boolean;
  public constructor(namedParameters: {key?: Key, colorTween?: ColorTween, animation?: Animation, item?: BottomNavigationBarItem, selectedLabelStyle?: TextStyle, unselectedLabelStyle?: TextStyle, showSelectedLabels?: boolean, showUnselectedLabels?: boolean} = {}) {
    super();
    this.key = namedParameters.key;
    this.colorTween = namedParameters.colorTween;
    this.animation = namedParameters.animation;
...
class _Circle extends MXDartClass {
  ...
  public constructor(namedParameters: {state?: _BottomNavigationBarState, index?: number, color?: Color, vsync?: TickerProvider} = {}) {
    super();
