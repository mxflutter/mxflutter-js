...
import { StatefulWidget, Widget, State, GlobalKey, GlobalObjectKey } from '../widgets/framework';
...
class ReorderableListView extends StatefulWidget {
  ...
  reverse: boolean;
  onReorder: any;
  public constructor(namedParameters: {key?: Key, header?: MXWidget, children?: Array<any>, onReorder?: any, scrollController?: ScrollController, scrollDirection?: Axis, padding?: EdgeInsets, reverse?: boolean} = {}) {
    super();
...
class _ReorderableListContent extends StatefulWidget {
  ...
  onReorder: any;
  reverse: boolean;
  public constructor(namedParameters: {header?: MXWidget, children?: Array<any>, scrollController?: ScrollController, scrollDirection?: Axis, padding?: EdgeInsets, onReorder?: any, reverse?: boolean} = {}) {
    super();
    this.header = namedParameters.header;
    this.children = namedParameters.children;
    this.scrollController = namedParameters.scrollController;
...
class _ReorderableListViewChildGlobalKey extends GlobalObjectKey {
  ...
  public constructor(subKey?: Key, state?: _ReorderableListContentState) {
    super();
    this.subKey = subKey;
    this.state = state;
