...
import { Widget, StatefulWidget, State, GlobalKey } from '../widgets/framework';
...
class MergeableMaterial extends StatefulWidget {
  ...
  hasDividers: boolean;
  dividerColor: Color;
  public constructor(namedParameters: {key?: Key, mainAxis?: Axis, elevation?: number, hasDividers?: boolean, children?: Array<any>, dividerColor?: Color} = {}) {
    super();
    this.key = namedParameters.key;
...
class _AnimationTuple extends MXDartClass {
  ...
  gapStart: number;
  public constructor(namedParameters: {controller?: AnimationController, startAnimation?: CurvedAnimation, endAnimation?: CurvedAnimation, gapAnimation?: CurvedAnimation, gapStart?: number} = {}) {
    super();
...
class _MergeableMaterialListBody extends ListBody {
  ...
  public constructor(namedParameters: {children?: Array<any>, mainAxis?: Axis, items?: Array<any>, boxShadows?: Array<any>} = {}) {
    super();
    this.children = namedParameters.children;
    this.mainAxis = namedParameters.mainAxis;
...
class _RenderMergeableMaterialListBody extends RenderListBody {
  boxShadows: Array<any>;
  public constructor(namedParameters: {children?: Array<any>, axisDirection?: AxisDirection, boxShadows?: Array<any>} = {}) {
    super();
    this['children'] = namedParameters.children;
