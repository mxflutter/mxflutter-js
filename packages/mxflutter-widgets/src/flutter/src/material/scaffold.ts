...
import { BuildContext, StatelessWidget, Widget, StatefulWidget, State, GlobalKey, InheritedWidget } from '../widgets/framework';
...
class ScaffoldPrelayoutGeometry extends MXDartClass {
  ...
  public constructor(namedParameters: {bottomSheetSize?: Size, contentBottom?: number, contentTop?: number, floatingActionButtonSize?: Size, minInsets?: EdgeInsets, minViewPadding?: EdgeInsets, scaffoldSize?: Size, snackBarSize?: Size, textDirection?: TextDirection} = {}) {
    super();
...
class _TransitionSnapshotFabLocation extends FloatingActionButtonLocation {
  ...
  progress: number;
  public constructor(begin?: FloatingActionButtonLocation, end?: FloatingActionButtonLocation, animator?: FloatingActionButtonAnimator, progress?: number) {
    super();
    this.begin = begin;
    this.end = end;
...
class _BodyBoxConstraints extends BoxConstraints {
  ...
  appBarHeight: number;
  public constructor(namedParameters: {minWidth?: number, maxWidth?: number, minHeight?: number, maxHeight?: number, bottomWidgetsHeight?: number, appBarHeight?: number} = {}) {
    super();
...
class _BodyBuilder extends StatelessWidget {
  ...
  public constructor(namedParameters: {key?: Key, extendBody?: boolean, extendBodyBehindAppBar?: boolean, body?: MXWidget} = {}) {
    super();
...
class _ScaffoldLayout extends MultiChildLayoutDelegate {
  ...
  snackBarWidth: number;
  public constructor(namedParameters: {minInsets?: EdgeInsets, minViewPadding?: EdgeInsets, textDirection?: TextDirection, geometryNotifier?: _ScaffoldGeometryNotifier, previousFloatingActionButtonLocation?: FloatingActionButtonLocation, currentFloatingActionButtonLocation?: FloatingActionButtonLocation, floatingActionButtonMoveAnimationProgress?: number, floatingActionButtonMotionAnimator?: FloatingActionButtonAnimator, isSnackBarFloating?: boolean, snackBarWidth?: number, extendBody?: boolean, extendBodyBehindAppBar?: boolean} = {}) {
    super();
    this.minInsets = namedParameters.minInsets;
    this.minViewPadding = namedParameters.minViewPadding;
    this.textDirection = namedParameters.textDirection;
...
class _FloatingActionButtonTransition extends StatefulWidget {
  ...
  public constructor(namedParameters: {key?: Key, child?: MXWidget, fabMoveAnimation?: Animation, fabMotionAnimator?: FloatingActionButtonAnimator, geometryNotifier?: _ScaffoldGeometryNotifier, currentController?: AnimationController} = {}) {
    super();
    this.key = namedParameters.key;
...
class Scaffold extends StatefulWidget {
  ...
  public constructor(namedParameters: {key?: Key, appBar?: PreferredSizeWidget, body?: MXWidget, floatingActionButton?: MXWidget, floatingActionButtonLocation?: FloatingActionButtonLocation, floatingActionButtonAnimator?: FloatingActionButtonAnimator, persistentFooterButtons?: Array<any>, drawer?: MXWidget, endDrawer?: MXWidget, bottomNavigationBar?: MXWidget, bottomSheet?: MXWidget, backgroundColor?: Color, resizeToAvoidBottomPadding?: boolean, resizeToAvoidBottomInset?: boolean, primary?: boolean, drawerDragStartBehavior?: DragStartBehavior, extendBody?: boolean, extendBodyBehindAppBar?: boolean, drawerScrimColor?: Color, drawerEdgeDragWidth?: number, drawerEnableOpenDragGesture?: boolean, endDrawerEnableOpenDragGesture?: boolean} = {}) {
    super();
    this.key = namedParameters.key;
...
class _StandardBottomSheet extends StatefulWidget {
  ...
  shape: ShapeBorder;
  clipBehavior: Clip;
  public constructor(namedParameters: {key?: Key, animationController?: AnimationController, enableDrag?: boolean, onClosing?: any, onDismissed?: any, builder?: any, isPersistent?: boolean, backgroundColor?: Color, elevation?: number, shape?: ShapeBorder, clipBehavior?: Clip} = {}) {
    super();
    this.key = namedParameters.key;
...
class _ScaffoldScope extends InheritedWidget {
  hasDrawer: boolean;
  geometryNotifier: _ScaffoldGeometryNotifier;
  public constructor(namedParameters: {key?: Key, hasDrawer?: boolean, geometryNotifier?: _ScaffoldGeometryNotifier, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
