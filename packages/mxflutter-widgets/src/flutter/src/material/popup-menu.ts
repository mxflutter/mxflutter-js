...
import { StatefulWidget, State, SingleChildRenderObjectWidget, Widget, StatelessWidget, BuildContext } from '../widgets/framework';
...
class PopupMenuItem extends PopupMenuEntry {
  ...
  child: MXWidget;
  public constructor(namedParameters: {key?: Key, value?: any, enabled?: boolean, height?: number, textStyle?: TextStyle, mouseCursor?: MouseCursor, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
...
class CheckedPopupMenuItem extends PopupMenuItem {
  checked: boolean;
  public constructor(namedParameters: {key?: Key, value?: any, checked?: boolean, enabled?: boolean, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
    this.value = namedParameters.value;
...
class _PopupMenuRouteLayout extends SingleChildLayoutDelegate {
  ...
  public constructor(position?: RelativeRect, itemSizes?: Array<any>, selectedItemIndex?: number, textDirection?: TextDirection) {
    super();
...
class _PopupMenuRoute extends PopupRoute {
  ...
  barrierLabel: string;
  public constructor(namedParameters: {position?: RelativeRect, items?: Array<any>, initialValue?: any, elevation?: number, theme?: ThemeData, popupMenuTheme?: PopupMenuThemeData, barrierLabel?: string, semanticLabel?: string, shape?: ShapeBorder, color?: Color, showMenuContext?: BuildContext, captureInheritedThemes?: boolean} = {}) {
    super();
...
class PopupMenuButton extends StatefulWidget {
  ...
  color: Color;
  captureInheritedThemes: boolean;
  public constructor(namedParameters: {key?: Key, itemBuilder?: any, initialValue?: any, onSelected?: any, onCanceled?: any, tooltip?: string, elevation?: number, padding?: EdgeInsetsGeometry, child?: MXWidget, icon?: MXWidget, offset?: Offset, enabled?: boolean, shape?: ShapeBorder, color?: Color, captureInheritedThemes?: boolean} = {}) {
    super();
    this.key = namedParameters.key;
