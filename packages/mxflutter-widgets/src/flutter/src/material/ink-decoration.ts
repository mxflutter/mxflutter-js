...
class Ink extends StatefulWidget {
  ...
  width: number;
  height: number;
  public constructor(namedParameters: {key?: Key, padding?: EdgeInsetsGeometry, color?: Color, decoration?: Decoration, width?: number, height?: number, child?: MXWidget} = {}) {
    super();
  ...
  static image(namedParameters: {key?: Key, padding?: EdgeInsetsGeometry, image?: ImageProvider, onImageError?: any, colorFilter?: ColorFilter, fit?: BoxFit, alignment?: AlignmentGeometry, centerSlice?: Rect, repeat?: ImageRepeat, matchTextDirection?: boolean, width?: number, height?: number, child?: MXWidget} = {}) {
    var jsObj = new Ink();
...
class InkDecoration extends InkFeature {
  ...
  public constructor(namedParameters: {decoration?: Decoration, configuration?: ImageConfiguration, controller?: MaterialInkController, referenceBox?: RenderBox, onRemoved?: any} = {}) {
    super();
    this.decoration = namedParameters.decoration;
