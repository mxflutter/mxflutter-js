...
class CircleAvatar extends StatelessWidget {
  ...
  minRadius: number;
  maxRadius: number;
  public constructor(namedParameters: {key?: Key, child?: MXWidget, backgroundColor?: Color, backgroundImage?: ImageProvider, onBackgroundImageError?: any, foregroundColor?: Color, radius?: number, minRadius?: number, maxRadius?: number} = {}) {
    super();
