...
import { StatelessWidget, Widget, StatefulWidget, GlobalKey, State } from '../widgets/framework';
...
class Drawer extends StatelessWidget {
  ...
  public constructor(namedParameters: {key?: Key, elevation?: number, child?: MXWidget, semanticLabel?: string} = {}) {
    super();
...
class DrawerController extends StatefulWidget {
  ...
  public constructor(namedParameters: {key?: GlobalKey, child?: MXWidget, alignment?: DrawerAlignment, drawerCallback?: any, dragStartBehavior?: DragStartBehavior, scrimColor?: Color, edgeDragWidth?: number, enableOpenDragGesture?: boolean} = {}) {
    super();
