...
class TabBarTheme extends MXDartClass {
  ...
  public constructor(namedParameters: {indicator?: Decoration, indicatorSize?: TabBarIndicatorSize, labelColor?: Color, labelPadding?: EdgeInsetsGeometry, labelStyle?: TextStyle, unselectedLabelColor?: Color, unselectedLabelStyle?: TextStyle} = {}) {
    super();
