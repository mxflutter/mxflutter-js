...
class RaisedButton extends MaterialButton {
  ...
  static icon(namedParameters: {key?: Key, onPressed?: any, onLongPress?: any, onHighlightChanged?: any, mouseCursor?: MouseCursor, textTheme?: ButtonTextTheme, textColor?: Color, disabledTextColor?: Color, color?: Color, disabledColor?: Color, focusColor?: Color, hoverColor?: Color, highlightColor?: Color, splashColor?: Color, colorBrightness?: Brightness, elevation?: number, highlightElevation?: number, disabledElevation?: number, shape?: ShapeBorder, clipBehavior?: Clip, focusNode?: FocusNode, autofocus?: boolean, padding?: EdgeInsetsGeometry, materialTapTargetSize?: MaterialTapTargetSize, animationDuration?: Duration, icon?: MXWidget, label?: MXWidget} = {}) {
