...
import { Offset, TextDirection, Color } from '../../../mx-dart-sdk';
...
class InkRipple extends InteractiveInkFeature {
  ...
  public constructor(namedParameters: {controller?: MaterialInkController, referenceBox?: RenderBox, position?: Offset, color?: Color, textDirection?: TextDirection, containedInkWell?: boolean, rectCallback?: any, borderRadius?: BorderRadius, customBorder?: ShapeBorder, radius?: number, onRemoved?: any} = {}) {
    super();
