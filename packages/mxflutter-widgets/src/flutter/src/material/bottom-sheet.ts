...
class BottomSheet extends StatefulWidget {
  ...
  shape: ShapeBorder;
  clipBehavior: Clip;
  public constructor(namedParameters: {key?: Key, animationController?: AnimationController, enableDrag?: boolean, onDragStart?: any, onDragEnd?: any, backgroundColor?: Color, elevation?: number, shape?: ShapeBorder, clipBehavior?: Clip, onClosing?: any, builder?: any} = {}) {
    super();
...
class _ModalBottomSheet extends StatefulWidget {
  ...
  clipBehavior: Clip;
  enableDrag: boolean;
  public constructor(namedParameters: {key?: Key, route?: _ModalBottomSheetRoute, backgroundColor?: Color, elevation?: number, shape?: ShapeBorder, clipBehavior?: Clip, isScrollControlled?: boolean, enableDrag?: boolean} = {}) {
    super();
    this.key = namedParameters.key;
...
class _ModalBottomSheetRoute extends PopupRoute {
  ...
  barrierLabel: string;
  animationController: AnimationController;
  public constructor(namedParameters: {builder?: any, theme?: ThemeData, barrierLabel?: string, backgroundColor?: Color, elevation?: number, shape?: ShapeBorder, clipBehavior?: Clip, modalBarrierColor?: Color, isDismissible?: boolean, enableDrag?: boolean, isScrollControlled?: boolean, settings?: RouteSettings} = {}) {
    super();
    this.builder = namedParameters.builder;
