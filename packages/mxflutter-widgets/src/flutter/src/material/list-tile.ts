...
import { Widget, StatelessWidget, RenderObjectWidget, RenderObjectElement } from '../widgets/framework';
...
class ListTileTheme extends InheritedTheme {
  ...
  public constructor(namedParameters: {key?: Key, dense?: boolean, shape?: ShapeBorder, style?: ListTileStyle, selectedColor?: Color, iconColor?: Color, textColor?: Color, contentPadding?: EdgeInsetsGeometry, tileColor?: Color, selectedTileColor?: Color, child?: MXWidget} = {}) {
    super();
...
class ListTile extends StatelessWidget {
  ...
  tileColor: Color;
  selectedTileColor: Color;
  public constructor(namedParameters: {key?: Key, leading?: MXWidget, title?: MXWidget, subtitle?: MXWidget, trailing?: MXWidget, isThreeLine?: boolean, dense?: boolean, visualDensity?: VisualDensity, shape?: ShapeBorder, contentPadding?: EdgeInsetsGeometry, enabled?: boolean, onTap?: any, onLongPress?: any, mouseCursor?: MouseCursor, selected?: boolean, focusColor?: Color, hoverColor?: Color, focusNode?: FocusNode, autofocus?: boolean, tileColor?: Color, selectedTileColor?: Color} = {}) {
    super();
    this.key = namedParameters.key;
...
class _ListTile extends RenderObjectWidget {
  ...
  public constructor(namedParameters: {key?: Key, leading?: MXWidget, title?: MXWidget, subtitle?: MXWidget, trailing?: MXWidget, isThreeLine?: boolean, isDense?: boolean, visualDensity?: VisualDensity, textDirection?: TextDirection, titleBaselineType?: TextBaseline, subtitleBaselineType?: TextBaseline} = {}) {
    super();
    this.key = namedParameters.key;
    this.leading = namedParameters.leading;
    this.title = namedParameters.title;
...
class _RenderListTile extends RenderBox {
  ...
  titleBaselineType: TextBaseline;
  subtitleBaselineType: TextBaseline;
  public constructor(namedParameters: {isDense?: boolean, visualDensity?: VisualDensity, isThreeLine?: boolean, textDirection?: TextDirection, titleBaselineType?: TextBaseline, subtitleBaselineType?: TextBaseline} = {}) {
    super();
    this.isDense = namedParameters.isDense;
    this.visualDensity = namedParameters.visualDensity;
    this.isThreeLine = namedParameters.isThreeLine;
