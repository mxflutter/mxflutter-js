...
import { StatefulWidget, Widget, State, InheritedWidget } from '../widgets/framework';
...
class FlexibleSpaceBar extends StatefulWidget {
  ...
  public constructor(namedParameters: {key?: Key, title?: MXWidget, background?: MXWidget, centerTitle?: boolean, titlePadding?: EdgeInsetsGeometry, collapseMode?: CollapseMode, stretchModes?: Array<any>} = {}) {
    super();
...
class FlexibleSpaceBarSettings extends InheritedWidget {
  ...
  public constructor(namedParameters: {key?: Key, toolbarOpacity?: number, minExtent?: number, maxExtent?: number, currentExtent?: number, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
