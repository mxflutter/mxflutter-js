...
class SnackBarThemeData extends MXDartClass {
  ...
  public constructor(namedParameters: {backgroundColor?: Color, actionTextColor?: Color, disabledActionTextColor?: Color, contentTextStyle?: TextStyle, elevation?: number, shape?: ShapeBorder, behavior?: SnackBarBehavior} = {}) {
    super();
