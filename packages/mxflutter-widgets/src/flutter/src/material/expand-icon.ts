...
class ExpandIcon extends StatefulWidget {
  ...
  disabledColor: Color;
  expandedColor: Color;
  public constructor(namedParameters: {key?: Key, isExpanded?: boolean, size?: number, onPressed?: any, padding?: EdgeInsetsGeometry, color?: Color, disabledColor?: Color, expandedColor?: Color} = {}) {
    super();
