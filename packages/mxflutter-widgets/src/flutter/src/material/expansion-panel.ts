...
import { Widget, StatefulWidget$, State$, BuildContext$ } from '../widgets/framework';
...
class ExpansionPanel extends MXDartClass {
  ...
  public constructor(
    namedParameters: { headerBuilder?: any; body?: MXWidget; isExpanded?: boolean; canTapOnHeader?: boolean } = {},
  ) {
    super();
...
class ExpansionPanelRadio extends ExpansionPanel {
  value: any;
  public constructor(
    namedParameters: { value?: any; headerBuilder?: any; body?: MXWidget; canTapOnHeader?: boolean } = {},
  ) {
    super();
