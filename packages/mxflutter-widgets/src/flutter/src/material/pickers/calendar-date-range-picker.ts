...
import { TextDirection, Color, Canvas, Size } from '../../../../mx-dart-sdk';
import {
  TraversalDirection,
  NextFocusIntent,
  PreviousFocusIntent,
...
class _FocusedDate extends InheritedWidget {
  ...
  public constructor(
    namedParameters: { key?: Key; child?: MXWidget; date?: DateTime; scrollDirection?: TraversalDirection } = {},
  ) {
    super();
    this.key = namedParameters.key;
    this.child = namedParameters.child;
...
class _HighlightPainter extends CustomPainter {
  ...
  public constructor(
    namedParameters: { color?: Color; style?: _HighlightPainterStyle; textDirection?: TextDirection } = {},
  ) {
    super();
