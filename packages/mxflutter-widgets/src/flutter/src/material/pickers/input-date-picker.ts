...
class InputDatePickerFormField extends StatefulWidget {
  ...
  autofocus: boolean;
  public constructor(namedParameters: {key?: Key, initialDate?: DateTime, firstDate?: DateTime, lastDate?: DateTime, onDateSubmitted?: any, onDateSaved?: any, selectableDayPredicate?: any, errorFormatText?: string, errorInvalidText?: string, fieldHintText?: string, fieldLabelText?: string, autofocus?: boolean} = {}) {
    super();
