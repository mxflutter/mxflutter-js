...
import { StatefulWidget, State, GlobalKey, StatelessWidget, Widget } from '../../widgets/framework';
...
class _DateRangePickerDialog extends StatefulWidget {
  ...
  public constructor(namedParameters: {key?: Key, initialDateRange?: DateTimeRange, firstDate?: DateTime, lastDate?: DateTime, currentDate?: DateTime, initialEntryMode?: DatePickerEntryMode, helpText?: string, cancelText?: string, confirmText?: string, saveText?: string, errorInvalidRangeText?: string, errorFormatText?: string, errorInvalidText?: string, fieldStartHintText?: string, fieldEndHintText?: string, fieldStartLabelText?: string, fieldEndLabelText?: string} = {}) {
    super();
...
class _CalendarRangePickerDialog extends StatelessWidget {
  ...
  confirmText: string;
  helpText: string;
  public constructor(namedParameters: {key?: Key, selectedStartDate?: DateTime, selectedEndDate?: DateTime, firstDate?: DateTime, lastDate?: DateTime, currentDate?: DateTime, onStartDateChanged?: any, onEndDateChanged?: any, onConfirm?: any, onCancel?: any, onToggleEntryMode?: any, confirmText?: string, helpText?: string} = {}) {
    super();
    this.key = namedParameters.key;
...
class _InputDateRangePickerDialog extends StatelessWidget {
  ...
  cancelText: string;
  helpText: string;
  public constructor(namedParameters: {key?: Key, selectedStartDate?: DateTime, selectedEndDate?: DateTime, currentDate?: DateTime, picker?: MXWidget, onConfirm?: any, onCancel?: any, onToggleEntryMode?: any, confirmText?: string, cancelText?: string, helpText?: string} = {}) {
    super();
    this.key = namedParameters.key;
    this.selectedStartDate = namedParameters.selectedStartDate;
    this.selectedEndDate = namedParameters.selectedEndDate;
