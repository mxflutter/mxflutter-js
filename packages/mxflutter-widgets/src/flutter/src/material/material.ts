...
import { StatefulWidget, Widget, State, GlobalKey, SingleChildRenderObjectWidget, StatelessWidget } from '../widgets/framework';
...
class Material extends StatefulWidget {
  ...
  public constructor(namedParameters: {key?: Key, type?: MaterialType, elevation?: number, color?: Color, shadowColor?: Color, textStyle?: TextStyle, borderRadius?: BorderRadiusGeometry, shape?: ShapeBorder, borderOnForeground?: boolean, clipBehavior?: Clip, animationDuration?: Duration, child?: MXWidget} = {}) {
    super();
...
class _RenderInkFeatures extends RenderProxyBox {
  ...
  public constructor(namedParameters: {child?: RenderBox, vsync?: TickerProvider, absorbHitTest?: boolean, color?: Color} = {}) {
    super();
    this['child'] = namedParameters.child;
...
class _InkFeatures extends SingleChildRenderObjectWidget {
  ...
  vsync: TickerProvider;
  absorbHitTest: boolean;
  public constructor(namedParameters: {key?: Key, color?: Color, vsync?: TickerProvider, absorbHitTest?: boolean, child?: MXWidget} = {}) {
    super();
    this.key = namedParameters.key;
    this.color = namedParameters.color;
    this.absorbHitTest = namedParameters.absorbHitTest;
...
class _MaterialInterior extends ImplicitlyAnimatedWidget {
  ...
  color: Color;
  shadowColor: Color;
  public constructor(namedParameters: {key?: Key, child?: MXWidget, shape?: ShapeBorder, borderOnForeground?: boolean, clipBehavior?: Clip, elevation?: number, color?: Color, shadowColor?: Color, curve?: Curve, duration?: Duration} = {}) {
    super();
    this.key = namedParameters.key;
    this.child = namedParameters.child;
    this.shape = namedParameters.shape;
