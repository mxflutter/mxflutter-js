...
import { Size, Color, TextDirection, Offset } from '../../../mx-dart-sdk';
import { Orientation, MediaQueryData } from '../widgets/media-query';
import { StatelessWidget, SingleChildRenderObjectWidget, Widget, StatefulWidget, State, GlobalKey } from '../widgets/framework';
...
class _TimePickerFragmentContext extends MXDartClass {
  ...
  public constructor(namedParameters: {selectedTime?: TimeOfDay, mode?: _TimePickerMode, onTimeChange?: any, onModeChange?: any, use24HourDials?: boolean} = {}) {
    super();
...
class _TimePickerHeader extends StatelessWidget {
  ...
  use24HourDials: boolean;
  helpText: string;
  public constructor(namedParameters: {selectedTime?: TimeOfDay, mode?: _TimePickerMode, orientation?: Orientation, onModeChanged?: any, onChanged?: any, use24HourDials?: boolean, helpText?: string} = {}) {
    super();
    this.selectedTime = namedParameters.selectedTime;
    this.mode = namedParameters.mode;
...
class _DialPainter extends CustomPainter {
  ...
  public constructor(namedParameters: {primaryLabels?: Array<any>, secondaryLabels?: Array<any>, backgroundColor?: Color, accentColor?: Color, dotColor?: Color, theta?: number, textDirection?: TextDirection, selectedValue?: number} = {}) {
    super();
...
class _Dial extends StatefulWidget {
  ...
  onChanged: any;
  onHourSelected: any;
  public constructor(namedParameters: {selectedTime?: TimeOfDay, mode?: _TimePickerMode, use24HourDials?: boolean, onChanged?: any, onHourSelected?: any} = {}) {
    super();
    this.selectedTime = namedParameters.selectedTime;
    this.mode = namedParameters.mode;
    this.use24HourDials = namedParameters.use24HourDials;
...
class _TimePickerInput extends StatefulWidget {
  ...
  helpText: string;
  onChanged: any;
  public constructor(namedParameters: {key?: Key, initialSelectedTime?: TimeOfDay, helpText?: string, onChanged?: any} = {}) {
    super();
    this.key = namedParameters.key;
...
class _HourTextField extends StatelessWidget {
  ...
  onChanged: any;
  public constructor(namedParameters: {key?: Key, selectedTime?: TimeOfDay, style?: TextStyle, validator?: any, onSavedSubmitted?: any, onChanged?: any} = {}) {
    super();
    this.key = namedParameters.key;
    this.selectedTime = namedParameters.selectedTime;
...
class _MinuteTextField extends StatelessWidget {
  ...
  validator: any;
  onSavedSubmitted: any;
  public constructor(namedParameters: {key?: Key, selectedTime?: TimeOfDay, style?: TextStyle, validator?: any, onSavedSubmitted?: any} = {}) {
    super();
    this.key = namedParameters.key;
    this.selectedTime = namedParameters.selectedTime;
    this.style = namedParameters.style;
...
class _HourMinuteTextField extends StatefulWidget {
  ...
  onSavedSubmitted: any;
  onChanged: any;
  public constructor(namedParameters: {key?: Key, selectedTime?: TimeOfDay, isHour?: boolean, style?: TextStyle, validator?: any, onSavedSubmitted?: any, onChanged?: any} = {}) {
    super();
    this.key = namedParameters.key;
    this.selectedTime = namedParameters.selectedTime;
...
class _TimePickerDialog extends StatefulWidget {
  ...
  confirmText: string;
  helpText: string;
  public constructor(namedParameters: {key?: Key, initialTime?: TimeOfDay, cancelText?: string, confirmText?: string, helpText?: string, initialEntryMode?: TimePickerEntryMode} = {}) {
    super();
    this.key = namedParameters.key;
