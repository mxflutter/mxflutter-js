...
import { InheritedWidget, Widget, StatefulWidget$, BuildContext$, State$ } from '../widgets/framework';
...
class _TabControllerScope extends InheritedWidget {
  ...
  enabled: boolean;
  public constructor(
    namedParameters: { key?: Key; controller?: TabController; enabled?: boolean; child?: MXWidget } = {},
  ) {
    super();
