...
class DrawerHeader extends StatelessWidget {
  ...
  curve: Curve;
  child: MXWidget;
  public constructor(namedParameters: {key?: Key, decoration?: Decoration, margin?: EdgeInsetsGeometry, padding?: EdgeInsetsGeometry, duration?: Duration, curve?: Curve, child?: MXWidget} = {}) {
    super();
