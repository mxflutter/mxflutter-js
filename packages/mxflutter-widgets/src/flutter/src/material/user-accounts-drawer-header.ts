...
import { Color, TextDirection, Size, Offset } from '../../../mx-dart-sdk';
import { Key } from '../foundation/key';
import { StatelessWidget$, Widget, BuildContext$, StatefulWidget$, State$ } from '../widgets/framework';
...
class _AccountPictures extends StatelessWidget$ {
  ...
  public constructor(
    namedParameters: { key?: Key; currentAccountPicture?: MXWidget; otherAccountsPictures?: Array<any> } = {},
  ) {
    super();
