...
import { PipelineOwner, PaintingContext, RenderObject } from '../rendering/object';
...
import { TextDirection, Color, Canvas, Size, TextAlign, TextBaseline, Offset } from '../../../mx-dart-sdk';
...
class _AffixText extends StatelessWidget$ {
  ...
  child: MXWidget;
  public constructor(
    namedParameters: { labelIsFloating?: boolean; text?: string; style?: TextStyle; child?: MXWidget } = {},
  ) {
    super();
