...
import { StatefulWidget$, State$, BuildContext$, Widget } from '../widgets/framework';
...
class SnackBarAction extends StatefulWidget$ {
  ...
  onPressed: any;
  public constructor(
    namedParameters: { key?: Key; textColor?: Color; disabledTextColor?: Color; label?: string; onPressed?: any } = {},
  ) {
    super();
