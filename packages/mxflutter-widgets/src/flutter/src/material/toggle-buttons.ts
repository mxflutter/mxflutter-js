...
import { StatelessWidget$, BuildContext$, Widget, SingleChildRenderObjectWidget } from '../widgets/framework';
...
class _SelectToggleButtonRenderObject extends RenderShiftedBox {
  ...
  public constructor(
    _leadingBorderSide?: BorderSide,
    _horizontalBorderSide?: BorderSide,
    _trailingBorderSide?: BorderSide,
