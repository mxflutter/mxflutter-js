...
import { DragUpdateDetails, DragStartDetails, DragEndDetails } from '../gestures/drag-details';
import { PipelineOwner, PaintingContext } from '../rendering/object';
import { CustomSemanticsAction, SemanticsConfiguration } from '../semantics/semantics';
...
class _RenderRangeSlider extends RenderBox {
  ...
  decreaseStart: CustomSemanticsAction;
  increaseStart: CustomSemanticsAction;
  decreaseEnd: CustomSemanticsAction;
  increaseEnd: CustomSemanticsAction;
  public constructor(
    namedParameters: {
      values?: RangeValues;
      divisions?: number;
