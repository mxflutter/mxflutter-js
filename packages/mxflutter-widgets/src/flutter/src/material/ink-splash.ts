...
class InkSplash extends InteractiveInkFeature {
  ...
  public constructor(namedParameters: {controller?: MaterialInkController, referenceBox?: RenderBox, textDirection?: TextDirection, position?: Offset, color?: Color, containedInkWell?: boolean, rectCallback?: any, borderRadius?: BorderRadius, customBorder?: ShapeBorder, radius?: number, onRemoved?: any} = {}) {
    super();
