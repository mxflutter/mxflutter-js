...
import { PointerEvent, PointerDownEvent, PointerHoverEvent } from '../gestures/events';
import { SemanticsConfiguration } from '../semantics/semantics';
import { PaintingContext, PipelineOwner } from './object';
import { Size, Offset, PointerDeviceKind } from '../../../mx-dart-sdk';
...
class _UiKitViewGestureRecognizer extends OneSequenceGestureRecognizer {
  ...
  public constructor(
    controller?: UiKitViewController,
    gestureRecognizerFactories?: Set<any>,
    namedParameters: { kind?: PointerDeviceKind } = {},
  ) {
    super();
