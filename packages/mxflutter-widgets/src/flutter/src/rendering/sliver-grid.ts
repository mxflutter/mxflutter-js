...
class SliverGridGeometry extends MXDartClass {
  ...
  public constructor(namedParameters: {scrollOffset?: number, crossAxisOffset?: number, mainAxisExtent?: number, crossAxisExtent?: number} = {}) {
    super();
...
class SliverGridRegularTileLayout extends SliverGridLayout {
  ...
  public constructor(namedParameters: {crossAxisCount?: number, mainAxisStride?: number, crossAxisStride?: number, childMainAxisExtent?: number, childCrossAxisExtent?: number, reverseCrossAxis?: boolean} = {}) {
    super();
...
class SliverGridDelegateWithFixedCrossAxisCount extends SliverGridDelegate {
  ...
  public constructor(namedParameters: {crossAxisCount?: number, mainAxisSpacing?: number, crossAxisSpacing?: number, childAspectRatio?: number} = {}) {
    super();
    this.crossAxisCount = namedParameters.crossAxisCount;
...
class SliverGridDelegateWithMaxCrossAxisExtent extends SliverGridDelegate {
  ...
  crossAxisSpacing: number;
  childAspectRatio: number;
  public constructor(namedParameters: {maxCrossAxisExtent?: number, mainAxisSpacing?: number, crossAxisSpacing?: number, childAspectRatio?: number} = {}) {
    super();
...
class RenderSliverGrid extends RenderSliverMultiBoxAdaptor {
  ...
  public constructor(namedParameters: {childManager?: RenderSliverBoxChildManager, gridDelegate?: SliverGridDelegate} = {}) {
    super();
