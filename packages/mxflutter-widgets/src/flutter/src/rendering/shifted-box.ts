...
import { PaintingContext, RenderObject, PipelineOwner } from './object';
import { TextBaseline, Offset, TextDirection, Rect, Clip, Size } from '../../../mx-dart-sdk';
...
class RenderPadding extends RenderShiftedBox {
  ...
  public constructor(
    namedParameters: { padding?: EdgeInsetsGeometry; textDirection?: TextDirection; child?: RenderBox } = {},
  ) {
    super();
