...
class CustomPainterSemantics extends MXDartClass {
  ...
  tags: Set<any>;
  public constructor(namedParameters: {key?: Key, rect?: Rect, properties?: SemanticsProperties, transform?: Matrix4, tags?: Set<any>} = {}) {
    super();
...
class RenderCustomPaint extends RenderProxyBox {
  ...
  public constructor(namedParameters: {painter?: CustomPainter, foregroundPainter?: CustomPainter, preferredSize?: Size, isComplex?: boolean, willChange?: boolean, child?: RenderBox} = {}) {
    super();
