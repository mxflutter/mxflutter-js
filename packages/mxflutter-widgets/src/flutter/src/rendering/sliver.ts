...
class SliverConstraints extends Constraints {
  ...
  public constructor(namedParameters: {axisDirection?: AxisDirection, growthDirection?: GrowthDirection, userScrollDirection?: ScrollDirection, scrollOffset?: number, precedingScrollExtent?: number, overlap?: number, remainingPaintExtent?: number, crossAxisExtent?: number, crossAxisDirection?: AxisDirection, viewportMainAxisExtent?: number, remainingCacheExtent?: number, cacheOrigin?: number} = {}) {
    super();
...
class SliverGeometry extends MXDartClass {
  ...
  cacheExtent: number;
  public constructor(namedParameters: {scrollExtent?: number, paintExtent?: number, paintOrigin?: number, layoutExtent?: number, maxPaintExtent?: number, maxScrollObstructionExtent?: number, hitTestExtent?: number, visible?: boolean, hasVisualOverflow?: boolean, scrollOffsetCorrection?: number, cacheExtent?: number} = {}) {
    super();
...
class SliverHitTestEntry extends HitTestEntry {
  ...
  public constructor(target?: RenderSliver, namedParameters: {mainAxisPosition?: number, crossAxisPosition?: number} = {}) {
    super();
