...
class PaintingContext extends ClipContext {
  ...
  static debugInstrumentRepaintCompositedChild(child?: RenderObject, namedParameters: {debugAlsoPaintedParent?: boolean, customContext?: PaintingContext} = {}) {
    var jsObj = new MXDartClass();
    jsObj['child'] = child;
    jsObj['debugAlsoPaintedParent'] = namedParameters.debugAlsoPaintedParent;
...
class PipelineOwner extends MXDartClass {
  ...
  public constructor(namedParameters: {onNeedVisualUpdate?: any, onSemanticsOwnerCreated?: any, onSemanticsOwnerDisposed?: any} = {}) {
    super();
...
class _SwitchableSemanticsFragment extends _InterestingSemanticsFragment {
  ...
  children: Array<any>;
  isExplicit: boolean;
  public constructor(namedParameters: {mergeIntoParent?: boolean, config?: SemanticsConfiguration, owner?: RenderObject, dropsSemanticsOfPreviousSiblings?: boolean} = {}) {
    super();
...
class _SemanticsGeometry extends MXDartClass {
  ...
  public constructor(namedParameters: {parentSemanticsClipRect?: Rect, parentPaintClipRect?: Rect, ancestors?: Array<any>} = {}) {
    super();
