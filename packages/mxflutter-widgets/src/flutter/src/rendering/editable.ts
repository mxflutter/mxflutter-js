...
class RenderEditable extends RenderBox {
  ...
  public constructor(namedParameters: {text?: TextSpan, textDirection?: TextDirection, textAlign?: TextAlign, cursorColor?: Color, backgroundCursorColor?: Color, showCursor?: ValueNotifier, hasFocus?: boolean, startHandleLayerLink?: LayerLink, endHandleLayerLink?: LayerLink, maxLines?: number, minLines?: number, expands?: boolean, strutStyle?: StrutStyle, selectionColor?: Color, textScaleFactor?: number, selection?: TextSelection, offset?: ViewportOffset, onSelectionChanged?: any, onCaretChanged?: any, ignorePointer?: boolean, readOnly?: boolean, forceLine?: boolean, textHeightBehavior?: TextHeightBehavior, textWidthBasis?: TextWidthBasis, obscuringCharacter?: string, obscureText?: boolean, locale?: Locale, cursorWidth?: number, cursorHeight?: number, cursorRadius?: Radius, paintCursorAboveText?: boolean, cursorOffset?: Offset, devicePixelRatio?: number, selectionHeightStyle?: BoxHeightStyle, selectionWidthStyle?: BoxWidthStyle, enableInteractiveSelection?: boolean, floatingCursorAddedMargin?: EdgeInsets, promptRectRange?: TextRange, promptRectColor?: Color, clipBehavior?: Clip, textSelectionDelegate?: TextSelectionDelegate} = {}) {
    super();
