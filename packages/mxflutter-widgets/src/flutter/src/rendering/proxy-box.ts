...
import { BlendMode, ImageFilter, TextDirection, Clip, Paint, Rect, Path, Color, Offset } from '../../../mx-dart-sdk';
...
class RenderAnimatedOpacity extends RenderProxyBox {
  public constructor(namedParameters: {opacity?: Animation, alwaysIncludeSemantics?: boolean, child?: RenderBox} = {}) {
    super();
    this['opacity'] = namedParameters.opacity;
    this['alwaysIncludeSemantics'] = namedParameters.alwaysIncludeSemantics;
    this['child'] = namedParameters.child;
...
class RenderClipRRect extends _RenderCustomClip {
  ...
  public constructor(namedParameters: {child?: RenderBox, borderRadius?: BorderRadius, clipper?: CustomClipper, clipBehavior?: Clip} = {}) {
    super();
    this['child'] = namedParameters.child;
...
class RenderPhysicalModel extends _RenderPhysicalModelBase {
  shape: BoxShape;
  borderRadius: BorderRadius;
  public constructor(namedParameters: {child?: RenderBox, shape?: BoxShape, clipBehavior?: Clip, borderRadius?: BorderRadius, elevation?: number, color?: Color, shadowColor?: Color} = {}) {
    super();
    this['child'] = namedParameters.child;
    this.shape = namedParameters.shape;
    this.clipBehavior = namedParameters.clipBehavior;
...
class RenderPhysicalShape extends _RenderPhysicalModelBase {
  public constructor(namedParameters: {child?: RenderBox, clipper?: CustomClipper, clipBehavior?: Clip, elevation?: number, color?: Color, shadowColor?: Color} = {}) {
    super();
    this['child'] = namedParameters.child;
    this['clipper'] = namedParameters.clipper;
    this['clipBehavior'] = namedParameters.clipBehavior;
...
class RenderDecoratedBox extends RenderProxyBox {
  ...
  public constructor(namedParameters: {decoration?: Decoration, position?: DecorationPosition, configuration?: ImageConfiguration, child?: RenderBox} = {}) {
    super();
...
class RenderTransform extends RenderProxyBox {
  ...
  transform: Matrix4;
  public constructor(namedParameters: {transform?: Matrix4, origin?: Offset, alignment?: AlignmentGeometry, textDirection?: TextDirection, transformHitTests?: boolean, child?: RenderBox} = {}) {
    super();
...
class RenderFittedBox extends RenderProxyBox {
  ...
  transform: Matrix4;
  clipBehavior: Clip;
  public constructor(namedParameters: {fit?: BoxFit, alignment?: AlignmentGeometry, textDirection?: TextDirection, child?: RenderBox, clipBehavior?: Clip} = {}) {
    super();
...
class RenderPointerListener extends RenderProxyBoxWithHitTestBehavior {
  ...
  onPointerCancel: any;
  onPointerSignal: any;
  public constructor(namedParameters: {onPointerDown?: any, onPointerMove?: any, onPointerUp?: any, onPointerCancel?: any, onPointerSignal?: any, behavior?: HitTestBehavior, child?: RenderBox} = {}) {
    super();
...
class RenderMouseRegion extends RenderProxyBox {
  ...
  onExit: any;
  cursor: MouseCursor;
  public constructor(namedParameters: {onEnter?: any, onHover?: any, onExit?: any, cursor?: MouseCursor, opaque?: boolean, child?: RenderBox} = {}) {
    super();
...
class RenderSemanticsGestureHandler extends RenderProxyBox {
  ...
  scrollFactor: number;
  public constructor(namedParameters: {child?: RenderBox, onTap?: any, onLongPress?: any, onHorizontalDragUpdate?: any, onVerticalDragUpdate?: any, scrollFactor?: number} = {}) {
    super();
    this['child'] = namedParameters.child;
...
class RenderFollowerLayer extends RenderProxyBox {
  ...
  offset: Offset;
  public constructor(namedParameters: {link?: LayerLink, showWhenUnlinked?: boolean, offset?: Offset, child?: RenderBox} = {}) {
    super();
    this.link = namedParameters.link;
