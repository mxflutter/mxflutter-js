...
import { Element$, Widget, StatefulWidget$, State$, GlobalKey, LeafRenderObjectWidget } from './framework';
import { Duration } from '../../../mx-dart-sdk';
import { RenderObject, PaintingContext } from '../rendering/object';
import { Offset, Canvas, Rect, Picture, PictureRecorder, TextDirection } from '../../../mx-dart-sdk';
...
declare class _TransformedRect extends MXDartClass {
    rect: Rect;
    transform: Matrix4;
    constructor(object?: RenderObject);
}
